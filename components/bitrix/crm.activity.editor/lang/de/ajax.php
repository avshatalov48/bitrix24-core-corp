...
$MESS["CRM_ACTIVITY_EMAIL_CREATION_LIMITED"] = "Sie haben das Limit für die Anzahl der E-Mails erreicht, die Sie in diesem Monat senden können. %link_start%Details%link_end%.";
$MESS["CRM_ACTIVITY_EMAIL_CUSTOM_LIMITED"] = "Sie haben das Limit für die Anzahl der E-Mails erreicht, die Sie pro Tag senden können. Bitte ändern Sie das Limit in den Absendereinstellungen. %link_start%Details%link_end%.";
