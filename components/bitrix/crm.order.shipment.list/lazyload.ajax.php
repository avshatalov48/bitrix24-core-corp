...
$ajaxLoaderParams = array(
	'url' => '/bitrix/components/bitrix/crm.order.shipment.list/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('bitrix:crm.order.shipment.list',
