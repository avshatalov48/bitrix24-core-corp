		...
		BX.ready(function() {
			...
			if (timelineItem)
			{
				...
				BX.message({
					...
					'CRM_DEAL_MANGO_NOTIFICATION_TEXT': '<?=GetMessageJS('CRM_DEAL_MANGO_NOTIFICATION_TEXT_' . $popupType)?>',
						...
						new BX.UI.CancelButton({
							...
							events: {
								click: () => {
									...
									BX.userOptions.save('crm', 'mango_notification_skip_to', 'value', skipNotificationTo);
									messageBox.close();
								}
							}
						})
