...
$MESS["CRM_DOCUMENT_VIEW_DOCUMENT_SEND_SEND_AGAIN"] = "Отправить повторно";
$MESS["CRM_DOCUMENT_VIEW_DOCUMENT_SEND_SEND_AGAIN_TIMER"] = "Отправить повторно через #COUNTDOWN#";
$MESS["CRM_DOCUMENT_VIEW_DOCUMENT_SEND_HINT"] = "отправить";
$MESS["CRM_DOCUMENT_VIEW_DOCUMENT_SEND_NOTIFY_SUCCESS"] = "Отправлено";
