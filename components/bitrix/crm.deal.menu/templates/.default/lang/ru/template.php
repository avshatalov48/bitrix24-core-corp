...
$MESS["CRM_DEAL_CATEGORY_SELECT_DLG_FIELD"] = "Воронка";
...
$MESS["CRM_DEAL_MOVE_TO_CATEGORY_DLG_SUMMARY"] = "Находящиеся в работе сделки переносятся в первую стадию новой воронки, выигранные  - в стадию \"Сделка заключена\", а проваленные в стадию \"Сделка не заключена\". Обратите внимание, что из истории будут удалены записи о изменении стадий старой воронки. Кроме того, пользовательские поля, которые участвовали в расчете данных для отчетов, начнут собирать статистику заново, с момента переноса сделок.";
