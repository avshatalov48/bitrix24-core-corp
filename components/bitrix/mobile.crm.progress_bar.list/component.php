...
$entityTypeName = mb_strtoupper(trim($entityTypeName));
...
$UID = $UID === ''
	? 'mobile_crm_progress_bar_list_'.mb_strtolower($entityTypeName)
	: str_replace('#ENTITY_TYPE#', mb_strtolower($entityTypeName), $UID);
