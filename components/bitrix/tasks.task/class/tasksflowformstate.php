...
final class TasksFlowFormState
{
	public const O_CHOSEN = 'C';
	public const O_OPENED = 'O';
	public const O_HIDDEN = 'H';

	public const OPT_NAME = 'task_flow_form_state';
	...
	{
		return Option::get('tasks', 'tasks_flow_form_reset_state', 'N') === 'Y';
	}

	private static function getReset(): array
	{
		self::reset();
		Option::set('tasks', 'tasks_flow_form_reset_state', 'N');
