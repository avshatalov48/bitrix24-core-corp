...
<div class="wraper-bi">
	<div class="ui-slider-section biconnector-market__description">
		<div class="biconnector-market__section-icon">
			<svg width="158" height="129" viewBox="0 0 158 129" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<path d="M54.48 84.6655C52.559 84.6655 51 83.1054 51 81.1812V71.3672C51 69.443 52.5615 67.8829 54.48 67.8829C55.4034 67.8862 56.288 68.2545 56.9406 68.9073C57.5931 69.5602 57.9605 70.4446 57.9624 71.3672V81.1837C57.9624 83.1078 56.4009 84.668 54.48 84.668V84.6655ZM65.6833 88.4296C63.7599 88.4296 62.2033 86.8695 62.2033 84.9453V67.6105C62.2033 65.6838 63.7599 64.1262 65.6833 64.1262C67.6067 64.1262 69.1657 65.6863 69.1657 67.6105V84.9453C69.1657 86.872 67.6042 88.4296 65.6833 88.4296ZM76.8866 92.1096C74.9632 92.1096 73.4066 90.5494 73.4066 88.6253V63.9107C73.4066 61.9841 74.9681 60.4264 76.8866 60.4264C78.805 60.4264 80.3666 61.9866 80.3666 63.9107V88.6203C80.3666 90.5469 78.81 92.1046 76.8866 92.1046V92.1096ZM106.258 51.7442L57.6724 37.1928C55.288 36.4499 53.1366 37.9357 53.1366 40.2462V64.5323C53.5797 64.4438 54.0305 64.399 54.4824 64.3986C54.9352 64.399 55.3868 64.4438 55.8308 64.5323V40.2635C55.8308 40.1001 55.8308 39.7187 56.4257 39.7187C56.5873 39.72 56.7478 39.7458 56.9016 39.7955L105.49 54.3469C106.546 54.6638 107.329 55.7386 107.329 56.489V87.6174C107.329 87.7957 107.329 88.1572 106.734 88.1572C106.573 88.157 106.413 88.131 106.261 88.0805L95.0523 84.7299V87.5406L105.462 90.6683C105.867 90.7912 106.287 90.8554 106.709 90.859C107.143 90.8787 107.576 90.8086 107.981 90.6531C108.386 90.4975 108.755 90.26 109.064 89.9554C109.373 89.6507 109.615 89.2855 109.776 88.8827C109.937 88.48 110.012 88.0483 109.998 87.6149V56.4592C109.998 54.441 108.345 52.3657 106.231 51.7343L106.258 51.7442ZM88.0899 95.9728C86.1665 95.9728 84.6099 94.4126 84.6099 92.4884V60.055C84.6099 58.1308 86.1715 56.5682 88.0899 56.5682C90.0084 56.5682 91.5699 58.1283 91.5699 60.055V92.5157C91.5699 94.4423 90.0133 96 88.0899 96V95.9728Z" fill="#4A4A4A"/>
			</svg>
		</div>
		<div class="biconnector-market__content">
			...
			<div class="ui-slider-inner-box">
				...
				<p class="ui-slider-paragraph-2 biconnector-market__section-paragraph">
					<a href="javascript:top.BX.Helper.show('redirect=detail&code=17402666');" class="biconnector-market__section-link"><?=Loc::getMessage('LINK_MANUAL_REPORT_TEMPLATES')?></a>
				</p>
				<div class="biconnector-market__info-block">
					...
					<div class="biconnector-market__info-message">
						...
						<span class="biconnector-market__info-message-icon" id="biconnector-ms_btn_copy_server_name"></span>
					</div>
					<div class="biconnector-market__info-message">
						...
						<span class="biconnector-market__info-message-icon" id="biconnector-ms_btn_copy_access_key"></span>
					</div>
				</div>
			</div>
		</div>
	...
	if (Loader::includeModule('market'))
	{
		...
		$APPLICATION->IncludeComponent(
			...
			[
				'IS_COLLECTION' => 'Y',
				'COLLECTION_CODE' => 'microsoft_power_bi',
				'HIDE_CATEGORIES' => 'Y',
				'HIDE_TOOLBAR' => 'Y',
				'HIDE_BREADCRUMBS' => 'Y',
				'SHOW_TITLE' => 'N',
...
<script>
	BX.ready(() => {
		BX.clipboard.bindCopyClick(
			'biconnector-ms_btn_copy_server_name',
			{
				text: '<?=CUtil::JSescape($arResult['SERVER_NAME'])?>'
			}
		);
		BX.clipboard.bindCopyClick(
			'biconnector-ms_btn_copy_access_key',
			{
