<?php
$MESS['DISK_DOCUMENTS_PAGE_TITLE'] = 'Документы';
...
$MESS['DISK_DOCUMENTS_TOOLBAR_CREATE'] = 'Создать';
$MESS['DISK_DOCUMENTS_TOOLBAR_CREATE_DOC'] = 'Документ';
$MESS['DISK_DOCUMENTS_TOOLBAR_CREATE_XLS'] = 'Таблица';
$MESS['DISK_DOCUMENTS_TOOLBAR_CREATE_PPT'] = 'Презентация';
$MESS['DISK_DOCUMENTS_TOOLBAR_OPEN'] = 'Открыть';
$MESS['DISK_DOCUMENTS_TOOLBAR_OPEN_LOCAL'] = 'Открыть с компьютера';
$MESS['DISK_DOCUMENTS_TOOLBAR_OPEN_DISK'] = 'Открыть с Битрикс24.Диска';
$MESS['DISK_DOCUMENTS_TOOLBAR_CHOOSE_DISK'] = 'Выбрать с Битрикс24.Диска';
$MESS['DISK_DOCUMENTS_TOOLBAR_OPEN_OFFICE_365'] = 'Выбрать с Office 365';
$MESS['DISK_DOCUMENTS_TOOLBAR_OPEN_GOOGLE_DOCS'] = 'Выбрать с Google Docs';
$MESS['DISK_DOCUMENTS_TOOLBAR_OPEN_DROPBOX'] = 'Выбрать с Dropbox';
$MESS['DISK_DOCUMENTS_GRID_VIEW_LIST'] = 'Список';
$MESS['DISK_DOCUMENTS_GRID_VIEW_SMALL_TILE'] = 'Сетка';
