...
$MESS["INTRANET_USER_LIST_ACTION_DEACTIVATE_INVITED_CONFIRM"] = "You cannot delete the invited user from Bitrix24 because there are bindings to other entities. Deactivate (dismiss) the user to close their access to this Bitrix24.

Do you want to dismiss the user?";
