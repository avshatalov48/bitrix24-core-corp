 ...
 */
class CrmStoreContractorContactListComponent extends \CBitrixComponent
{
	/** @var bool bool */
	private $isIframe;
	...
	public function executeComponent()
	{
		...
		$categoryId = CategoryRepository::getIdByEntityTypeId(\CCrmOwnerType::Contact);
		if (!$categoryId)
		{
		...
		$this->arResult['PATH_TO_LIST'] = $this->arParams['PATH_TO']['CONTRACTORS_CONTACTS'] ?? '';
