...
jn.define('tasks/checklist/legacy', (require, exports, module) => {
	...
	class CheckListFilesList extends BaseList
	{
		...
		static getFileSize(size)
		{
			...
			{
				fileSize = `${(fileSize / 1024).toFixed(1)} ${Loc.getMessage(
					'TASKSMOBILE_CHECKLIST_FILES_LIST_ITEM_SIZE_MB',
				)}`;
			}
					...
					settings: {
						...
						attachButton: {
							items: [
								{
									id: 'disk',
									name: Loc.getMessage('TASKSMOBILE_CHECKLIST_IMAGE_PICKER_BITRIX24_DISK_MSGVER_1'),
									dataSource: {
										multiple: true,
										url: diskUrl,
									},
