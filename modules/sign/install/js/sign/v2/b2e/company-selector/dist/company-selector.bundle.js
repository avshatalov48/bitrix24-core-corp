...
(function (exports,main_core,main_core_cache,main_core_events,main_date,main_loader,main_popup,sign_tour,sign_v2_api,sign_v2_b2e_hcmLinkCompanySelector,sign_v2_b2e_schemeSelector,sign_v2_companyEditor,sign_v2_documentSetup,sign_v2_helper,ui_alerts,ui_entitySelector,ui_label) {
	'use strict';
	...
	class CompanySelector extends main_core_events.EventEmitter {
	  constructor(options = {}) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _integrationSelector)[_integrationSelector].setAvailability(options.hcmLinkAvailable);
	  ...
	  getLayout() {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].hcmLinkAvailable) {
	...
	function _toggleProviderState2(rqInn) {
	  ...
	  if ((company == null ? void 0 : (_company$providers4 = company.providers) == null ? void 0 : _company$providers4.length) > 0) {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].region === 'ru' && babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].documentInitiatedType !== sign_v2_documentSetup.DocumentInitiated.employee) {
...
}((this.BX.Sign.V2.B2e = this.BX.Sign.V2.B2e || {}),BX,BX.Cache,BX.Event,BX.Main,BX,BX.Main,BX.Sign.Tour,BX.Sign.V2,BX.Sign.V2.B2e,BX.Sign.V2.B2e,BX.Sign.V2,BX.Sign.V2,BX.Sign.V2,BX.UI,BX.UI.EntitySelector,BX.UI));
