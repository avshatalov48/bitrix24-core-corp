...
(function (exports,main_core) {
	...
	var MyDocumentsGrid = /*#__PURE__*/function () {
	  function MyDocumentsGrid() {
	    babelHelpers.classCallCheck(this, MyDocumentsGrid);
	    _classPrivateMethodInitSpec(this, _reload);
	  }
	  babelHelpers.createClass(MyDocumentsGrid, [{
	    key: "openSignSliderByGridId",
	    value: function openSignSliderByGridId(gridId) {
	      var _this = this;
	      main_core.Event.ready(function () {
	        var gridContainer = document.querySelector(gridId);
	        if (!gridContainer) {
	          return;
	        }
	              ...
	              while (1) switch (_context.prev = _context.next) {
	                ...
	                case 4:
	                  if (target.classList.contains('sign-action-button')) {
	                    ...
	                    BX.Runtime.loadExtension('sign.v2.b2e.sign-link').then(function (exports) {
	                      return new exports.SignLink({
	                        ...
	                        events: {
	                          onClose: function onClose() {
	                            BX.ajax.runAction('sign.api_v1.B2e.Document.Member.callStatus', {
	                              json: {
	                                memberId: memberId
	                              }
	                            }).then(function () {
	  ...
	  return MyDocumentsGrid;
	}();
	function _reload2() {
	  main_core.Event.ready(function () {
	    var _BX$Main$gridManager$;
	    var grid = (_BX$Main$gridManager$ = BX.Main.gridManager.getById('SIGN_B2E_MY_DOCUMENTS_GRID')) === null || _BX$Main$gridManager$ === void 0 ? void 0 : _BX$Main$gridManager$.instance;
	...
	exports.MyDocumentsGrid = MyDocumentsGrid;

}((this.BX.Sign.V2.B2e = this.BX.Sign.V2.B2e || {}),BX));
