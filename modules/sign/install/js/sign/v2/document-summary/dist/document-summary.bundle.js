...
(function (exports,main_core,sign_v2_api,main_core_events) {
	...
	var _editDocumentBtn = /*#__PURE__*/new WeakMap();
	...
	var DocumentSummary = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function DocumentSummary() {
	    ...
	    _classPrivateFieldInitSpec(babelHelpers.assertThisInitialized(_this), _blocks, {
	      writable: true,
	      value: void 0
	    });
	    _classPrivateFieldInitSpec(babelHelpers.assertThisInitialized(_this), _editDocumentBtn, {
	      writable: true,
	      value: void 0
	    });
	    _classPrivateFieldInitSpec(babelHelpers.assertThisInitialized(_this), _number, {
	      writable: true,
	      value: null
	    });
	    _this.setEventNamespace('BX.Sign.V2.DocumentSummary');
	    _this.subscribeFromOptions(options.events);
	    babelHelpers.classPrivateFieldSet(babelHelpers.assertThisInitialized(_this), _editDocumentBtn, main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<span\n\t\t\t\tclass=\"", "\"\n\t\t\t\tonclick=\"", "\"\n\t\t\t>\n\t\t\t\t", "\n\t\t\t</span>\n\t\t"])), buttonClassList.join(' '), function () {
	      return _this.emit('showEditor');
	  ...
	  babelHelpers.createClass(DocumentSummary, [{
	    ...
	    value: function setNumber(number) {
	      babelHelpers.classPrivateFieldSet(this, _number, number);
	    }
	  }, {
	    key: "getLayout",
	    value: function getLayout() {
	      return main_core.Tag.render(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<div class=\"sign-document-summary\">\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t</div>\n\t\t"])), _classPrivateMethodGet(this, _createDocumentDetails, _createDocumentDetails2).call(this), babelHelpers.classPrivateFieldGet(this, _editDocumentBtn));
	    }
	  }, {
	    key: "blocks",
	    set: function set(blocks) {
	      babelHelpers.classPrivateFieldSet(this, _blocks, blocks);
	...
	function _createDocumentDetails2() {
	  var _this$title,
	    _this2 = this;
	  var title = main_core.Text.encode((_this$title = this.title) !== null && _this$title !== void 0 ? _this$title : '');
	  return main_core.Tag.render(_templateObject3 || (_templateObject3 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<div class=\"sign-document-summary__details\">\n\t\t\t\t<div class=\"sign-document-summary__details_title\">\n\t\t\t\t\t<span\n\t\t\t\t\t\tclass=\"sign-document-summary__details_title-text\"\n\t\t\t\t\t\ttitle=\"", "\"\n\t\t\t\t\t>\n\t\t\t\t\t\t", "\n\t\t\t\t\t</span>\n\t\t\t\t\t<span\n\t\t\t\t\t\tclass=\"sign-document-summary__details_edit-title-btn\"\n\t\t\t\t\t\tonclick=\"", "\"\n\t\t\t\t\t>\n\t\t\t\t\t</span>\n\t\t\t\t</div>\n\t\t\t\t", "\n\t\t\t</div>\n\t\t"])), title, title, function (_ref) {
	    ...
	    _classPrivateMethodGet(_this2, _toggleTitleEditor, _toggleTitleEditor2).call(_this2, button, true);
	  }, _classPrivateMethodGet(this, _createNumber, _createNumber2).call(this));
	}
	function _createNumber2() {
	  if (!babelHelpers.classPrivateFieldGet(this, _number)) {
	    return null;
	  }
	  var title = main_core.Loc.getMessage('SIGN_DOCUMENT_SUMMARY_REG_NUMBER', {
	    '#NUMBER#': main_core.Text.encode(babelHelpers.classPrivateFieldGet(this, _number))
	  });
	...
	function _createTitleEditor2() {
	  ...
	  input.value = (_this$title2 = this.title) !== null && _this$title2 !== void 0 ? _this$title2 : '';
	      ...
	      return _regeneratorRuntime().wrap(function _callee$(_context) {
	        while (1) switch (_context.prev = _context.next) {
	          case 0:
	            ...
	            _context.next = 4;
	            return _classPrivateMethodGet(_this3, _modifyDocumentTitle, _modifyDocumentTitle2).call(_this3, input.value);
	          case 4:
	            main_core.Dom.removeClass(target, 'ui-btn-wait');
	            _classPrivateMethodGet(_this3, _toggleTitleEditor, _toggleTitleEditor2).call(_this3, target, false);
	          case 6:
	          case "end":
	...
	function _toggleTitleEditor2(button, shouldShow) {
	  ...
	  if (shouldShow) {
	    ...
	    main_core.Dom.append(_classPrivateMethodGet(this, _createTitleEditor, _createTitleEditor2).call(this), summaryNode);
	    return;
	  }
	  main_core.Dom.replace(summaryNode.firstElementChild, _classPrivateMethodGet(this, _createDocumentDetails, _createDocumentDetails2).call(this));
	  main_core.Dom.append(babelHelpers.classPrivateFieldGet(this, _editDocumentBtn), summaryNode);
	}
	...
	function _modifyDocumentTitle2(_x2) {
	  return _modifyDocumentTitle3.apply(this, arguments);
	}
	function _modifyDocumentTitle3() {
	  _modifyDocumentTitle3 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(newValue) {
	    var api, titleData;
	    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
	      while (1) switch (_context2.prev = _context2.next) {
	        ...
	        case 2:
	          ...
	          _context2.next = 6;
	          return api.modifyTitle(this.uid, newValue);
	        case 6:
