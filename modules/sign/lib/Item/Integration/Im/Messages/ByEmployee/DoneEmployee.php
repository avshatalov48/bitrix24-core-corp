...
class DoneEmployee extends Message\WithInitiator\ByEmployee
{
	...
	public function getStageId(): string
	{
		...
		{
			Gender::MALE => 'byEmployeeDoneEmployeeM',
			Gender::FEMALE => 'byEmployeeDoneEmployeeF',
			default => 'byEmployeeDoneEmployee',
		};
	}
	...
	public function getFallbackText(): string
	{
		...
		{
			Gender::MALE => 'SIGN_CALLBACK_CHAT_BY_EMPLOYEE_DONE_EMPLOYEEM',
			Gender::FEMALE => 'SIGN_CALLBACK_CHAT_BY_EMPLOYEE_DONE_EMPLOYEEF',
			default  => 'SIGN_CALLBACK_CHAT_BY_EMPLOYEE_DONE_EMPLOYEE',
		};
