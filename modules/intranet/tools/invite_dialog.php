...
?><div style="width: 542px; min-height: 200px; padding: 5px; overflow-y: auto; margin: 5px;">
	...
	else
	{
		...
		)
		{
			...
			$strAction = (in_array($strAction, array("invite", "invite-phone", "add", "self", "integrator")) ? $strAction : false);
			...
			{
				ob_end_clean();
				if ($strAction == "invite" || $strAction == 'invite-phone')
					$mess = "INVITED";
				elseif($strAction == "add")
					$mess = "ADDED";
				elseif ($strAction == "self")
