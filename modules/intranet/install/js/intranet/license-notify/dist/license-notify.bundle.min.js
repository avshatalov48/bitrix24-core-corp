this.BX=this.BX||{},function(e,t,s,i,o,a,l){"use strict";class r{show(){throw new Error("Must be implemented in a child class")}close(){throw new Error("Must be implemented in a child class")}}let n,c,p=e=>e;var b=babelHelpers.classPrivateFieldLooseKey("cache"),d=babelHelpers.classPrivateFieldLooseKey("getPopup"),u=babelHelpers.classPrivateFieldLooseKey("getContent"),h=babelHelpers.classPrivateFieldLooseKey("getDate"),O=babelHelpers.classPrivateFieldLooseKey("getDescriptionWithPartner"),P=babelHelpers.classPrivateFieldLooseKey("getButtons"),L=babelHelpers.classPrivateFieldLooseKey("getPartnerButton"),N=babelHelpers.classPrivateFieldLooseKey("getRenewalButton"),v=babelHelpers.classPrivateFieldLooseKey("getMoreInformationButton");class T extends r{constructor(e){super(),Object.defineProperty(this,v,{value:E}),Object.defineProperty(this,N,{value:y}),Object.defineProperty(this,L,{value:g}),Object.defineProperty(this,P,{value:_}),Object.defineProperty(this,O,{value:B}),Object.defineProperty(this,h,{value:f}),Object.defineProperty(this,u,{value:F}),Object.defineProperty(this,d,{value:I}),Object.defineProperty(this,b,{writable:!0,value:new a.Cache.MemoryCache}),this.setOptions(e)}setOptions(e){babelHelpers.classPrivateFieldLooseBase(this,b)[b].set("options",e)}getOptions(){return babelHelpers.classPrivateFieldLooseBase(this,b)[b].get("options",null)}show(){i.BannerDispatcher.critical.toQueue((e=>{const t=babelHelpers.classPrivateFieldLooseBase(this,d)[d]();t.subscribe("onAfterClose",(t=>{e()})),t.show()}))}close(){babelHelpers.classPrivateFieldLooseBase(this,d)[d]().close()}}function I(){return babelHelpers.classPrivateFieldLooseBase(this,b)[b].remember("popup",(()=>new t.Popup({className:"bitrix24-notify-popup",width:800,padding:0,content:babelHelpers.classPrivateFieldLooseBase(this,u)[u](),contentBackground:"transparent",overlay:!0,closeIcon:!0,titleBar:!1,buttons:babelHelpers.classPrivateFieldLooseBase(this,P)[P](),events:{onShow:()=>{a.ajax.runComponentAction(Y.componentName,"setLicenseNotifyConfig",{mode:"class",data:{type:this.getOptions().popupType}})}}})))}function F(){return babelHelpers.classPrivateFieldLooseBase(this,b)[b].remember("popup-content",(()=>a.Tag.render(n||(n=p`
			...
			`),a.Loc.getMessage("INTRANET_NOTIFY_PANEL_LICENSE_NOTIFICATION_DESCRIPTION_2"))))}function _(){return this.getOptions().isCIS?[babelHelpers.classPrivateFieldLooseBase(this,N)[N](),this.getOptions().isAdmin?babelHelpers.classPrivateFieldLooseBase(this,L)[L]():null,babelHelpers.classPrivateFieldLooseBase(this,v)[v]()]:[this.getOptions().isAdmin?babelHelpers.classPrivateFieldLooseBase(this,L)[L]():null,babelHelpers.classPrivateFieldLooseBase(this,N)[N](),babelHelpers.classPrivateFieldLooseBase(this,v)[v]()]}function g(){return babelHelpers.classPrivateFieldLooseBase(this,b)[b].remember("partner-button",(()=>this.getOptions().isPortalWithPartner?new s.Button({color:this.getOptions().isCIS?s.Button.Color.LIGHT_BORDER:s.Button.Color.SUCCESS,text:a.Loc.getMessage("INTRANET_NOTIFY_PANEL_LICENSE_NOTIFICATION_BUTTON_PARTNER"),round:!0,onclick:()=>{window.open(this.getOptions().urlBuyWithPartner,"_self")}}):null))}function y(){return babelHelpers.classPrivateFieldLooseBase(this,b)[b].remember("renewal-button",(()=>new s.Button({color:this.getOptions().isCIS?s.Button.Color.SUCCESS:s.Button.Color.LIGHT_BORDER,text:a.Loc.getMessage("INTRANET_NOTIFY_PANEL_LICENSE_NOTIFICATION_BUTTON_RENEW_LICENSE"),round:!0,onclick:()=>{window.open(this.getOptions().urlDefaultBuy,"_blank")}})))}function E(){return babelHelpers.classPrivateFieldLooseBase(this,b)[b].remember("more-button",(()=>new s.Button({color:s.Button.Color.LIGHT_BORDER,text:a.Loc.getMessage("INTRANET_NOTIFY_PANEL_LICENSE_NOTIFICATION_BUTTON_MORE"),round:!0,onclick:()=>{window.open(this.getOptions().urlArticle,"_blank")}})))}let m,H=e=>e;var C=babelHelpers.classPrivateFieldLooseKey("cache"),A=babelHelpers.classPrivateFieldLooseKey("classActivity"),w=babelHelpers.classPrivateFieldLooseKey("getPanel"),x=babelHelpers.classPrivateFieldLooseKey("getMessage"),D=babelHelpers.classPrivateFieldLooseKey("getBlockDate");class R extends r{constructor(e){super(),Object.defineProperty(this,D,{value:K}),Object.defineProperty(this,x,{value:S}),Object.defineProperty(this,w,{value:M}),Object.defineProperty(this,C,{writable:!0,value:new a.Cache.MemoryCache}),this.setOptions(e)}show(){const e=document.querySelector(".bx-layout-table");e&&a.Dom.insertBefore(babelHelpers.classPrivateFieldLooseBase(this,w)[w](),e)}close(){a.Dom.hasClass(babelHelpers.classPrivateFieldLooseBase(this,w)[w](),babelHelpers.classPrivateFieldLooseBase(R,A)[A])&&a.Dom.removeClass(babelHelpers.classPrivateFieldLooseBase(this,w)[w](),babelHelpers.classPrivateFieldLooseBase(R,A)[A])}}function M(){const e=()=>{this.close()};return babelHelpers.classPrivateFieldLooseBase(this,C)[C].remember("panel-template",(()=>a.Tag.render(m||(m=H`
...
//# sourceMappingURL=license-notify.bundle.map.js