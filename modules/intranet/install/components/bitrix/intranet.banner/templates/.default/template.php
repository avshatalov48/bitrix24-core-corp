...
?>
<?if ($arParams['ALLOW_CLOSE'] == 'Y'):?><script>if (null == window.phpVars) window.phpVars = {}; if (!window.phpVars.bitrix_sessid) window.phpVars.bitrix_sessid='<?=bitrix_sessid()?>';</script><?endif;?>
