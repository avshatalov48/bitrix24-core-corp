...
(function (exports,main_core_events,ui_vue,main_core,main_loader,main_popup) {
	...
	var ContentComponent = {
	  ...
	  props: ["license", "market", "telephony", "isAdmin", "isCloud", "partner", "isExperimentalTemplate"],
	  computed: {
	...
	var PopupWrapperComponent = {
	  ...
	  props: ["licenseType", "isExperimentalTemplate"],
	  data: function data() {
	    return {
	      loaded: false,
	      loading: true,
	        ...
	        computed: {
	          ...
	          buttonName: function buttonName() {
	            ...
	            if (this.isFreeLicense) {
	              buttonName = this.isExperimentalTemplate ? BX.message("INTRANET_LICENSE_WIDGET_START_FREE_TRIAL") : BX.message("INTRANET_LICENSE_WIDGET_BUY_TARIFF");
