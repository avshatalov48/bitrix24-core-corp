...
<div class="bx-user-fields">
	<ul>
		...
		<li><b>���. ����������: </b><?=$arResult['USER']['UF_PHONE_INNER']?></li>
		<li><b>���. ���������: </b><?=$arResult['USER']['PERSONAL_MOBILE']?></li>
		<li><b>�����: </b><?=$arResult['USER']['PERSONAL_STREET']?></li>
	</ul>
</div>
...
?>
<div style="bx-back-url"><a href="<?=$arParams['LIST_URL']?>">� ������ �������������</a></div>
<?
endif;
?>
