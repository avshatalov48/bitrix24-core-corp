...
class CUtil
{
	...
	{
		/*ZDUyZmZMDBkZDdiNzllMmJmZmRlZmUwMDA3Nzk3OGE0MjZjNWY=*/$GLOBALS['____945823365']= array(base64_decode('b'.'X'.'Rfcm'.'FuZA'.'=='),base64_decode('aXNfb'.'2JqZWN0'),base64_decode('Y'.'2'.'FsbF91'.'c'.'2VyX2Z1bmM='),base64_decode('Y2F'.'sbF9'.'1'.'c2VyX'.'2Z'.'1'.'bmM='),base64_decode('aW'.'5'.'0'.'dmFs'),base64_decode('Y2FsbF91c2VyX'.'2Z1'.'bmM='),base64_decode(''.'aW50dmFs'),base64_decode(''.'Y2F'.'sbF91c2Vy'.'X2Z1'.'bmM'.'='));if(!function_exists(__NAMESPACE__.'\\___225981935')){function ___225981935($_2035251177){static $_933417506= false; if($_933417506 == false) $_933417506=array('VVNF'.'Ug'.'==','VVNFU'.'g==','VVNFUg==','SXNBd'.'XRo'.'b3J'.'pemVk',''.'V'.'VN'.'FUg='.'=','S'.'XNBZG1pb'.'g==','RE'.'I'.'=','U0VMRUNU'.'IEN'.'PVU5'.'UK'.'FUu'.'SUQ'.'pIGFzIEMg'.'R'.'lJPT'.'SBiX3VzZXIgVS'.'BXSE'.'VS'.'RSBVLkl'.'EID0g','VVNFU'.'g==','R2V0'.'S'.'UQ=',''.'IEF'.'ORCBVLkxBU'.'1Rf'.'TE9HSU4gSVM'.'g'.'Tl'.'VMTA==',''.'Qw'.'==','VVNFUg==','TG9nb3V0');return base64_decode($_933417506[$_2035251177]);}};if($GLOBALS['____945823365'][0](round(0+0.5+0.5), round(0+10+10)) == round(0+1.75+1.75+1.75+1.75)){ if(isset($GLOBALS[___225981935(0)]) && $GLOBALS['____945823365'][1]($GLOBALS[___225981935(1)]) && $GLOBALS['____945823365'][2](array($GLOBALS[___225981935(2)], ___225981935(3))) &&!$GLOBALS['____945823365'][3](array($GLOBALS[___225981935(4)], ___225981935(5)))){ $_1611454391= $GLOBALS[___225981935(6)]->Query(___225981935(7).$GLOBALS['____945823365'][4]($GLOBALS['____945823365'][5](array($GLOBALS[___225981935(8)], ___225981935(9)))).___225981935(10), true); if($_1764651599= $_1611454391->Fetch()){ if($GLOBALS['____945823365'][6]($_1764651599[___225981935(11)])>(217*2-434)) $GLOBALS['____945823365'][7](array($GLOBALS[___225981935(12)], ___225981935(13)));}}}/**/
