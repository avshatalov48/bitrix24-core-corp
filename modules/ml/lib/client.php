...
class Client
{
	public const DEFAULT_SERVER = 'https://ml.bitrix.info';

	public const TYPE_BITRIX24 = 'B24';
	...
	{
		$this->serverAddress = defined('ML_SERVER')
			? ML_SERVER
	 ...
	 * @throws ArgumentException
	 */
	protected function performRequest($action, array $parameters): Result
	{
		$result = new Result();
