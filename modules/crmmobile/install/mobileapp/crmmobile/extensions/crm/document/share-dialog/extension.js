		...
		renderButton({ title, subtitle, leftIcon, rightIcon, onClick, border, rounded, disabled })
		{
			return View(
				...
				View(
					...
					subtitle && Text({
						text: subtitle.text ? subtitle.text : subtitle,
						numberOfLines: 1,
						ellipsize: 'end',
						style: {
							color: subtitle.color ? subtitle.color : '#525C69',
							fontSize: subtitle.fontSize ? subtitle.fontSize : 13,
						},
					}),
				),
