	...
	class TimelineSchedulerCommentProvider extends TimelineSchedulerBaseProvider
	{
		...
		get comment()
		{
			...
			const regExp = new RegExp(
				`\\[URL=data:\\/\\/user=([0-9]+)]\\[COLOR=${Color.accentMainLinks}]\\[B](.*)\\[\\/B]\\[\\/COLOR]\\[\\/URL]`,
				'gm',
			);
