...
jn.define('crm/timeline/item/ui/footer', (require, exports, module) => {
	...
	function getTimelineButtonBackground(type)
	{
		...
		{
			return withPressed('#00a2e8');
		}

		const { default: defaultColor, pressed } = withPressed('#ffffff');
