...
jn.define('crm/receive-payment/steps/payment-systems/paysystem-settings', (require, exports, module) => {
	...
	const styles = {
		...
		item: {
			...
			title: (disabled) => {
				return {
					color: disabled ? AppTheme.colors.base3 : AppTheme.colors.base0,
				};
			},
			box: {
				width: 130,
