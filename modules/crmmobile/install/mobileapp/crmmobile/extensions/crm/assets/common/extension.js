...
jn.define('crm/assets/common', (require, exports, module) => {
	...
	const edit = (color = AppTheme.colors.base4) => `<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.4358 5.53516L18.9863 8.11258L9.00867 18.0634L6.4581 15.486L16.4358 5.53516ZM5.02549 19.173C5.00137 19.2643 5.02721 19.3607 5.09267 19.4279C5.15986 19.495 5.25634 19.5209 5.34764 19.495L8.19884 18.7269L5.79384 16.3227L5.02549 19.173Z" fill="${color}"/></svg>`;
