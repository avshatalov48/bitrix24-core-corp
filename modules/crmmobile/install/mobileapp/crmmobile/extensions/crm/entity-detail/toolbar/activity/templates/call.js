...
jn.define('crm/entity-detail/toolbar/activity/templates/call', (require, exports, module) => {
	...
	class ActivityPinnedCallWrapper extends LayoutComponent
	{
		...
		{
			Haptics.impactLight();
			this.state.duration && this.customEventEmitter.emit('TopPanelAudioPlayer::onChangePlay', []);
		}
	...
	const icons = {
		...
		cancel: `<svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.6166 10.1138L10.114 11.6164L14.9976 16.5L10.114 21.3836L11.6166 22.8862L16.5002 18.0026L21.3835 22.8859L22.8861 21.3833L18.0028 16.5L22.8861 11.6167L21.3835 10.1141L16.5002 14.9974L11.6166 10.1138Z" fill="#DFE0E3"/><rect width="33" height="33" rx="16.5" fill="white" fill-opacity="0.01"/></svg>`,
		speed: {
