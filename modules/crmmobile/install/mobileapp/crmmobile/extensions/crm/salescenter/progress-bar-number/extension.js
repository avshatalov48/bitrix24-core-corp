/**
 * @module crm/salescenter/progress-bar-number
 */
jn.define('crm/salescenter/progress-bar-number', (require, exports, module) => {
	const AppTheme = require('apptheme');
	const { PureComponent } = require('layout/pure-component');

	const SUCCESS_SVG = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="9" fill="${AppTheme.colors.accentMainSuccess}" stroke="${AppTheme.colors.bgPrimary}" stroke-width="2"/><path fill-rule="evenodd" clip-rule="evenodd" d="M9.20471 10.9085L13.4299 6.7373L14.7085 8.02302L9.22469 13.4598L9.20471 13.4397L9.18473 13.4598L5.83008 10.2129L7.1087 8.9272L9.20471 10.9085Z" fill="white"/></svg>`;
