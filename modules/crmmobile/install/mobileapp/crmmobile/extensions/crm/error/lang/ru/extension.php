<?php
$MESS['MCRM_ERROR_ACCESS_DENIED_TITLE'] = 'Недостаточно прав на просмотр элемента';
$MESS['MCRM_ERROR_ACCESS_DENIED_TITLE_LEAD'] = 'Недостаточно прав на просмотр лида';
...
$MESS['MCRM_ERROR_NOT_FOUND_TITLE'] = 'Элемент не найден';
$MESS['MCRM_ERROR_NOT_FOUND_TITLE_LEAD'] = 'Лид не найден';
...
$MESS['MCRM_ERROR_INTERNAL_ERROR_TITLE'] = 'Произошла внутренняя ошибка';
$MESS['MCRM_ERROR_INTERNAL_ERROR_TEXT'] = "Попробуйте повторить попытку чуть позже. \nВ случае, если ошибка продолжит возникать, обратитесь к администратору вашего Битрикс24 или сотруднику, который отвечает за CRM.";

$MESS['MCRM_ERROR_ALERT_CONFIRM'] = 'Понятно';
