		...
		<div class="salescenter-main-header">
			<div class="salescenter-main-header-left-block">
				<div class="salescenter-logo-container">
					<img class="salescenter-logo" src="<?=$templateFolder?>/images/logo_sms.png" alt="">
				</div>
			</div>
			<div class="salescenter-main-header-right-block">
				<div class="salescenter-main-header-title"><?=Loc::getMessage('SALESCENTER_CONNECT_TEMPLATE_TITLE_SMS');?></div>
				<div class="salescenter-description"><?=Loc::getMessage('SALESCENTER_CONNECT_TEMPLATE_DESCRIPTION_SMS');?></div>
				<div class="salescenter-link-container">
					<a class="salescenter-link" onclick="BX.Salescenter.Manager.openHowSmsWorks(event);"><?=Loc::getMessage('SALESCENTER_CONNECT_TEMPLATE_HOW_LINK_SMS');?></a>
				</div>
...
<div class="salescenter-wrapper">
	<div class="salescenter-section">
		...
		<div class="salescenter-description"><?=Loc::getMessage('SALESCENTER_CONNECT_TEMPLATE_HOW_DESCRIPTION_SMS');?></div>
		<div class="salescenter-img-container">
			<img class="img-response" src="<?=$templateFolder?>/images/sms.png" alt="">
		</div>
	</div>
</div>
<div class="salescenter-wrapper">
	<div class="salescenter-section">
		<div class="salescenter-header">
			<div class="salescenter-header-title"><?=Loc::getMessage('SALESCENTER_CONNECT_TEMPLATE_TITLE');?></div>
		</div>
		<hr class="salescenter-separator">
