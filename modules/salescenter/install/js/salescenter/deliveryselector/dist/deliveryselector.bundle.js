this.BX = this.BX || {};
(function (exports,salescenter_manager,location_core,location_widget,ui_vue,main_core) {
	'use strict';
...
}((this.BX.Salescenter = this.BX.Salescenter || {}),BX.Salescenter,BX.Location.Core,BX.Location.Widget,BX,BX));
