...
(function (exports,main_core) {
	...
	var Custom = /*#__PURE__*/function (_Base) {
	  babelHelpers.inherits(Custom, _Base);
	  function Custom(props) {
	    var _this;
	    babelHelpers.classCallCheck(this, Custom);
	    _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(Custom).call(this, props));
	    _this.icon = main_core.Type.isString(props.icon) && props.icon.length > 0 ? props.icon : '';
	    return _this;
	  }
	...
	var Payment = /*#__PURE__*/function (_Base) {
	  ...
	  function Payment(props) {
	    ...
	    _this.sum = typeof props.sum === 'undefined' ? '0.00' : props.sum; // .toFixed(2)
	    ...
	    _this.currencyCode = main_core.Type.isString(props.currencyCode) && props.currencyCode.length > 0 ? props.currencyCode : '';
	    return _this;
	  }
	...
	var items = [Cash, Check, CheckSent, Custom, Payment, Sent, Watch];
