...
INSERT INTO b_catalog_currency_lang (CURRENCY, LID, FORMAT_STRING, FULL_NAME, DEC_POINT, THOUSANDS_SEP, DECIMALS) VALUES('USD', 'ru', '$#', '������ ���', '.', ',', 2);
...
INSERT INTO b_catalog_currency_lang (CURRENCY, LID, FORMAT_STRING, FULL_NAME, DEC_POINT, THOUSANDS_SEP, DECIMALS) VALUES('RUR', 'ru', '# ���', '�����', '.', '\\xA0', 2);
