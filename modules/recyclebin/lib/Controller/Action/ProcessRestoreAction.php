...
class ProcessRestoreAction extends Action
{
	use ProcessTrait;
	...
	{
		return Recyclebin::restore($currentEntityId);
	}

	protected function getErrorMessage(): string
	{
		return Loc::getMessage('RECYCLEBIN_PROCESS_RESTORE_ACTION_COMMON_RESTORE_ERROR');
	}
