(() => {
	...
	class AppUpdateNotifier extends LayoutComponent
	{
		...
		renderText()
		{
			return Text({
				...
				text: (this.props.text || BX.message('APP_UPDATE_NOTIFIER_NEED_UPDATE')),
			});
		}
		...
		renderIphoneButton()
		{
			return this.renderButton(
				'https://apps.apple.com/ru/app/bitrix24/id561683423',
				BX.message('APP_UPDATE_NOTIFIER_OPEN_APP_STORE')
			);
		}
		...
		renderAndroidButton()
		{
			return this.renderButton(
				...
				BX.message('APP_UPDATE_NOTIFIER_OPEN_PLAY_MARKET')
			)
		}
		...
		renderButton(link, text)
		{
			return View(
				...
				Button({
					...
					text: BX.message('APP_UPDATE_NOTIFIER_CLOSE'),
	...
	layout.showComponent(new AppUpdateNotifier());
})();
