(() =>
{
	 ...
	 * - Added class "WordSeparator" and constants "asciiWordRegExp" and "hasUnicodeWordRegExp". For correct splitting of strings by words.
	 */
	...
	//Bitrix Framework integration start
	...
	//Bitrix Framework integration end
})();
