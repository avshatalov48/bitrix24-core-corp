/**
 * @module layout/ui/product-grid/components/sku-selector/elements/sku-tree-property-value
 */
jn.define('layout/ui/product-grid/components/sku-selector/elements/sku-tree-property-value', (require, exports, module) => {
	const skip = () => {};
	...
	function SkuTreePropertyValue(props)
	{
		return View(
			...
			View(
				{
					style: {
						borderColor: props.selected ? AppTheme.colors.accentBrandBlue : AppTheme.colors.bgSeparatorPrimary,
						borderWidth: 1,
						borderRadius: 4,
						padding: 10,
						flexDirection: 'row',
