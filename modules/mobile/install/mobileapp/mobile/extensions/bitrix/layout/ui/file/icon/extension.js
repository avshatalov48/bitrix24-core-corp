	...
	function renderFileExtension(fileExt, color)
	{
		...
		return trim(`
			<svg xmlns="http://www.w3.org/2000/svg" width="85" height="44" x="15" y="53">
				...
				<text x="43" y="${textTop}" fill="#fff" font-family="sans-serif" font-size="${textSize}" text-anchor="middle">${fileExt}</text>
			</svg>
		`);
	}
