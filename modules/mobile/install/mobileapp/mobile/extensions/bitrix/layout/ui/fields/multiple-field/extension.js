...
jn.define('layout/ui/fields/multiple-field', (require, exports, module) => {
	...
	const svgImages = {
		addField: {
			content: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect opacity="0.3" x="0.25" y="0.25" width="23.5" height="23.5" rx="11.75" stroke="${AppTheme.colors.base3}" stroke-width="0.5"/><path fill-rule="evenodd" clip-rule="evenodd" d="M13 6H11V11H6V13H11V18H13V13H18V11H13V6Z" fill="${AppTheme.colors.base3}"/></svg>`,
		},
		deleteField: {
			content: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect opacity="0.3" x="0.25" y="0.25" width="23.5" height="23.5" rx="11.75" stroke="${AppTheme.colors.base3}" stroke-width="0.5"/><path fill-rule="evenodd" clip-rule="evenodd" d="M16.9497 8.46537L15.5355 7.05116L12 10.5867L8.46447 7.05116L7.05025 8.46537L10.5858 12.0009L7.05025 15.5364L8.46447 16.9507L12 13.4151L15.5355 16.9507L16.9497 15.5364L13.4142 12.0009L16.9497 8.46537Z" fill="${AppTheme.colors.base3}"/></svg>`,
		},
	};
