...
jn.define('layout/ui/audio-player/play-button', (require, exports, module) => {
	...
	const CompactLayout = ({ play, onClick, isLoading, onLoadAudio, duration }) => View(
		{
			style: {
				...
				alignItems: 'center',
				borderColor: play ? '#BDC1C6' : '#7FDEFC',
				borderWidth: 1,
				borderRadius: 512,
				marginRight: 7,
			},
	...
	const svgImages = {
		...
		playCompact: `<svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.4831 9.29253L7.90344 5.08726C7.77188 4.98672 7.60048 4.97533 7.45892 5.05774C7.31736 5.14014 7.22923 5.30261 7.23037 5.47908V13.8892C7.2287 14.0659 7.31675 14.2289 7.45852 14.3114C7.60028 14.3939 7.77199 14.3822 7.90344 14.281L13.4831 10.0758C13.6011 9.98785 13.6718 9.84112 13.6718 9.68414C13.6718 9.52717 13.6011 9.38044 13.4831 9.29253Z" fill="#2FC6F6"/></svg>`,
		pauseCompact: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.0158 6.08073C9.0158 5.80459 8.79194 5.58073 8.5158 5.58073H7.50183C7.22569 5.58073 7.00183 5.80459 7.00183 6.08073V13.2878C7.00183 13.5639 7.22569 13.7878 7.50183 13.7878H8.5158C8.79194 13.7878 9.0158 13.5639 9.0158 13.2878V6.08073Z" fill="#151515"/><path d="M13.3314 6.08073C13.3314 5.80459 13.1076 5.58073 12.8314 5.58073H11.8175C11.5413 5.58073 11.3175 5.80459 11.3175 6.08073V13.2878C11.3175 13.5639 11.5413 13.7878 11.8175 13.7878H12.8314C13.1076 13.7878 13.3314 13.5639 13.3314 13.2878V6.08073Z" fill="#151515"/></svg>`,
	};
