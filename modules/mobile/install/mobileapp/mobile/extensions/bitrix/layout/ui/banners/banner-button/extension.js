/**
 * @module layout/ui/banners/banner-button
 */
jn.define('layout/ui/banners/banner-button', (require, exports, module) => {
	...
	{
		options = options || {};
		options.backgroundColor = BX.prop.getString(options, 'backgroundColor', AppTheme.colors.accentSoftBlue1);
