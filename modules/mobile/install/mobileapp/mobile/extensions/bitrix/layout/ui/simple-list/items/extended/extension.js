...
jn.define('layout/ui/simple-list/items/extended', (require, exports, module) => {
	...
	{
		static hasCounter(counterValue)
		{
		...
		renderMenuIcon()
		{
			if (this.isMenuEnabled())
			{
				...
				return View(
					{
						style: this.styles.menuContainer(Extended.hasCounter(counterValue)),
					...
					ImageButton({
						...
						svg: {
							content: Extended.getMenuFilledColor(svgImages.menu, counterValue),
						},
						onClick: () => this.showMenuHandler(data.id),
					}),
				);
