...
ChatDialog.userDialog.open = function (params)
{
	...
	app.exec("openComponent", {
		...
		scriptPath: "/mobile/mobile_component/im.chat.user.list/?version="+BX.componentParameters.get('WIDGET_CHAT_USERS_VERSION', '1.0.0'),
		params: {
			"LIST_TYPE": type,
...
ChatDialog.userAddDialog.open = function (dialogId)
{
	...
	app.exec("openComponent", {
		...
		scriptPath: "/mobile/mobile_component/im.chat.user.selector/?version="+BX.componentParameters.get('WIDGET_CHAT_RECIPIENTS_VERSION', '1.0.0'),
		params: {
			"DIALOG_ID": dialogId,
			"USER_ID": this.base.userId,
...
ChatDialog.transferDialog.open = function (chatId)
{
	...
	app.exec("openComponent", {
		...
		scriptPath: "/mobile/mobile_component/im.chat.transfer.selector/?version="+BX.componentParameters.get('WIDGET_CHAT_TRANSFER_VERSION', '1.0.0'),
		params: {
			"CHAT_ID": chatId,
			"USER_ID": this.base.userId,
