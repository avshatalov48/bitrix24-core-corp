...
(function (exports,main_core_events,rpa_manager,main_popup,main_core,ui_timeline) {
	...
	function _templateObject18() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"ui-item-detail-stream-content-employee\" title=\"", "\" ", "></span>"]);
	...
	function _templateObject14() {
	  var data = babelHelpers.taggedTemplateLiteral(["<a class=\"ui-btn ui-btn-sm ui-btn-default ui-btn-primary\" \n\t\t\t\t\thref=\"", "\"\n\t\t\t\t\t>", "</a>\n\t\t\t"]);
	...
	function _templateObject13() {
	  var data = babelHelpers.taggedTemplateLiteral(["<button class=\"ui-btn ui-btn-sm ui-btn-default\" \n\t\t\t\t\tname=\"", "\"\n\t\t\t\t\tvalue=\"", "\"\n\t\t\t\t\tstyle=\"background-color: #", ";border-color: #", ";color:", "\"\n\t\t\t\t\tonclick=\"", "\"\n\t\t\t\t\t>", "</button>\n\t\t\t\t"]);
	...
	function _templateObject9() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"ui-item-detail-popup-item-separator\">\n\t\t\t\t\t", "\n\t\t\t\t\t</span>"]);
	...
	function _templateObject7() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"ui-item-detail-stream-content-detail-subject-separator\">", "</span>"]);
	...
	function _templateObject6() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"ui-item-detail-stream-content-detail-subject-resp\">", "</span>"]);
	...
	function _templateObject5() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"ui-item-detail-stream-content-employee-wrap\" onclick=\"", "\">\n\t\t\t\t", "\n\t\t\t</div>\n\t\t"]);
	...
	function _templateObject4() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"ui-item-detail-stream-content-other\">\n\t\t\t\t\t\t<span class=\"ui-item-detail-stream-content-other-text\">+", "</span>\n\t\t\t\t\t</span>"]);
	...
	function _templateObject() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"ui-item-detail-stream-section ui-item-detail-stream-section-task ", "\"></div>"]);
	...
	function (_Timeline$Item) {
	  ...
	  babelHelpers.createClass(Task, [{
	    ...
	    value: function renderHeader() {
	      return main_core.Tag.render(_templateObject2(), main_core.Loc.getMessage('RPA_TIMELINE_TASKS_TITLE'));
	    }
	  }, {
	    key: "renderMain",
	    value: function renderMain() {
	      return main_core.Tag.render(_templateObject3(), this.renderParticipants(), main_core.Text.encode(this.data.url), main_core.Text.encode(this.getTitle()), this.renderParticipantsLine(), main_core.Text.encode(this.description), this.renderTaskFields(), this.renderTaskButtons());
	    }
	  }, {
	    ...
	    value: function renderParticipants() {
	      ...
	      if (photos.length > 4) {
	        ...
	        photos.push(main_core.Tag.render(_templateObject4(), counter));
	      }

	      return main_core.Tag.render(_templateObject5(), this.showParticipants.bind(this), photos);
	    }
	  }, {
	    ...
	    value: function renderParticipantsLine() {
	      ...
	      taskUsers.forEach(function (_ref2, i) {
	        var id = _ref2.id,
	            status = _ref2.status;
	        var node = main_core.Tag.render(_templateObject6(), main_core.Text.encode(_this3.getTaskUserName(id)));
	        ...
	        if (_this3.data.participantJoint !== 'queue' && taskUsers.length - 1 !== i) {
	          ...
	          elements.push(main_core.Tag.render(_templateObject7(), main_core.Loc.getMessage(msg)));
	        }
	      });
	      var queueCls = this.data.participantJoint === 'queue' ? 'ui-item-detail-stream-content-detail-subject-resp-wrap-queue' : '';
	      return main_core.Tag.render(_templateObject8(), queueCls, elements);
	    }
	  }, {
	    ...
	    value: function showParticipants(event) {
	      ...
	      var users = taskUsers.map(function (_ref3, i) {
	        ...
	        var sep = taskUsers.length - 1 !== i ? main_core.Tag.render(_templateObject9(), main_core.Loc.getMessage(_this4.data.participantJoint === 'and' ? 'RPA_TIMELINE_TASKS_SEPARATOR_AND' : 'RPA_TIMELINE_TASKS_SEPARATOR_OR')) : '';
	        var node = main_core.Tag.render(_templateObject10(), user.link ? "href=\"".concat(user.link, "\"") : '', main_core.Text.encode(user.fullName), user.photo ? "style=\"background-image: url('".concat(user.photo, "'); background-size: 100%;\"") : '', main_core.Text.encode(user.fullName), user.workPosition, sep);
	      ...
	      var content = main_core.Tag.render(_templateObject11(), users);
	    ...
	    value: function renderTaskButtons() {
	      ...
	      return main_core.Tag.render(_templateObject12(), elements);
	    }
	  }, {
	    ...
	    value: function getActionButtonElements(buttons) {
	      ...
	      return buttons.map(function (button) {
	        ...
	        return main_core.Tag.render(_templateObject13(), button.NAME, button.VALUE, bgColor, bgColor, fgColor, _this5.doTaskHandler.bind(_this5, button), main_core.Text.encode(button.TEXT));
	      });
	    }
	  }, {
	    key: "getLinkButtonElements",
	    value: function getLinkButtonElements(buttons) {
	      return [main_core.Tag.render(_templateObject14(), main_core.Text.encode(this.data.url), main_core.Loc.getMessage('RPA_TIMELINE_TASKS_OPEN_TASK'))];
	    }
	  }, {
	    ...
	    value: function renderTaskFields() {
	      ...
	      var elements = this.data.fieldsToSet.map(function (field) {
	        return main_core.Tag.render(_templateObject15(), main_core.Text.encode(field));
	      });
	      return main_core.Tag.render(_templateObject16(), main_core.Loc.getMessage('RPA_TIMELINE_TASKS_FIELDS_TO_SET'), elements);
	    }
	  }, {
	    key: "getTaskUserName",
	    ...
	    value: function renderParticipantPhoto(userId) {
	      ...
	      if (!userData) {
	        return main_core.Tag.render(_templateObject17());
	      }
	...
	function _templateObject6$1() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"ui-item-detail-stream-content-detail-main\">\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t</div>"]);
	...
	function _templateObject5$1() {
	  var data = babelHelpers.taggedTemplateLiteral(["<span class=\"ui-item-detail-stream-content-detail-main-text\">", "</span>"]);
	...
	function _templateObject2$1() {
	  var data = babelHelpers.taggedTemplateLiteral(["<a class=\"ui-item-detail-stream-content-detail-subject-text\">", "</a>"]);
	...
	function _templateObject$1() {
	  var data = babelHelpers.taggedTemplateLiteral(["<div class=\"ui-item-detail-stream-content-detail-subject\">\n\t\t\t", "\n\t\t\t<div class=\"ui-item-detail-stream-content-detail-subject-inner\">\n\t\t\t\t", "\n\t\t\t\t", "\n\t\t\t</div>\n\t\t</div>"]);
	...
	function (_Timeline$History) {
	  ...
	  babelHelpers.createClass(TaskComplete, [{
	    ...
	    value: function renderTaskInfo() {
	      ...
	      return main_core.Tag.render(_templateObject$1(), this.renderHeaderUser(this.getUserId(), 30), taskName, taskResponsible);
	    }
	  }, {
	    key: "renderTaskName",
	    value: function renderTaskName() {
	      ...
	      if (task) {
	        return main_core.Tag.render(_templateObject2$1(), main_core.Text.encode(task.NAME));
	      }
	    ...
	    value: function renderTaskResponsible() {
	      ...
	      if (user) {
	        return main_core.Tag.render(_templateObject3$1(), main_core.Text.encode(user.fullName));
	      }
	    ...
	    value: function renderMain() {
	      ...
	      return main_core.Tag.render(_templateObject4$1(), taskInfo, detailMain || '');
	    }
	  }, {
	    key: "getTask",
	    ...
	    value: function renderDetailMain() {
	      ...
	      if (task && task.DESCRIPTION) {
	        taskDescription = main_core.Tag.render(_templateObject5$1(), main_core.Text.encode(task.DESCRIPTION));
	      }
	      ...
	      if (taskDescription || stageChange || fieldsChange) {
	        return main_core.Tag.render(_templateObject6$1(), taskDescription, fieldsChange ? [this.renderFieldsChangeTitle(), fieldsChange] : '', stageChange ? [this.renderStageChangeTitle(), stageChange] : '');
	      }
