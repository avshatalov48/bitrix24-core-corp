...
(function (exports,main_core,main_popup) {
	...
	var _templateObject;
	var FieldsPopup = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(FieldsPopup, [{
	    ...
	    value: function getContent() {
	      ...
	      return main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["<div class=\"rpa-fields-popup-wrapper\">\n\t\t\t\t\t\t\t<div class=\"rpa-fields-popup-inner\">", "</div>\n\t\t\t\t\t\t</div>"])), content);
	    }
	  }, {
	    key: "renderField",
