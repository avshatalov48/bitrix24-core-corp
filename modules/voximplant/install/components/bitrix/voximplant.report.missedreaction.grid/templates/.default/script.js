;(function()
{
	...
	BX.Voximplant.Report.MissedReactionGrid = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("telephony-report-missed-reaction-grid-value-clickable");
	...
	BX.Voximplant.Report.MissedReactionGrid.bindEvents();
})();
