;(function()
{
	...
	BX.Voximplant.Report.EmployeesWorkloadGrid = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("telephony-report-employees-workload-grid-value-clickable");
	...
	BX.Voximplant.Report.EmployeesWorkloadGrid.bindEvents();
})();
