;(function()
{
	...
	BX.Voximplant.Report.LostCalls = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("telephony-report-lost-calls-grid-value-clickable");
		...
		updateWidgetTitle: function()
		{
			...
			BX.adjust(this.widget.layout.titleContainer, {
				children: [
					...
					this.elements.hint = BX.UI.Hint.createNode(BX.message("TELEPHONY_REPORT_LOST_CALLS_HELP"))
				]
			});
		}
	};

	BX.Voximplant.Report.LostCalls.bindEvents();
})();
