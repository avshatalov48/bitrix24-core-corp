;(function()
{
	...
	BX.Voximplant.Report.CallDurationGrid = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("telephony-report-call-duration-grid-value-clickable");
	...
	BX.Voximplant.Report.CallDurationGrid.bindEvents();
})();
