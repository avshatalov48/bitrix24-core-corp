;(function()
{
	...
	BX.Voximplant.Report.CallActivityGrid = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("telephony-report-call-activity-grid-value-clickable");
	...
	BX.Voximplant.Report.CallActivityGrid.bindEvents();
})();
