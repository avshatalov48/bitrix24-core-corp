...
class VoximplantReportCallDynamicsGridComponent extends \CBitrixComponent
{
	protected $gridId = 'telephony_report_call_dynamics_by_employee_grid';
	...
	protected function getColumns()
	{
		$columns = [
			[
				'id' => 'EMPLOYEE',
				'sort' => 'EMPLOYEE',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_EMPLOYEE'),
				'default' => true,
			],
			[
				'id' => 'INCOMING',
				'sort' => 'INCOMING',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_INCOMING'),
				'default' => true,
			],
			[
				'id' => 'OUTGOING',
				'sort' => 'OUTGOING',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_OUTGOING'),
				'default' => true,
			],
			[
				'id' => 'MISSED',
				'sort' => 'MISSED',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_MISSED'),
				'default' => true,
			],
			[
				'id' => 'CALLBACK',
				'sort' => 'CALLBACK',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_CALLBACK'),
				'default' => true,
			],
			[
				'id' => 'COUNT',
				'sort' => 'COUNT',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_COUNT'),
				'default' => true,
			],
			[
				'id' => 'DYNAMICS',
				'sort' => 'DYNAMICS',
				'name' => Loc::getMessage('TELEPHONY_REPORT_CALL_DYNAMICS_DYNAMICS'),
				'default' => true,
			],
		];
