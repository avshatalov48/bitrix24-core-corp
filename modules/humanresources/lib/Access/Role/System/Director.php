...
class Director extends Base
{
	public function getPermissions(): array
	{
		return [
			...
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_CREATE => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUBDEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_DELETE => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUBDEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_EDIT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUBDEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_EMPLOYEE_ADD_TO_DEPARTMENT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUBDEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_EMPLOYEE_REMOVE_FROM_DEPARTMENT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUBDEPARTMENTS,
	...
	{
		return RoleDictionary::getTitle(RoleDictionary::ROLE_DIRECTOR);
	}
}