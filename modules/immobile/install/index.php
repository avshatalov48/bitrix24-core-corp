...
class ImMobile extends CModule
{
	public $MODULE_ID = 'immobile';
	...
	public function __construct()
	{
		...
		$this->MODULE_NAME = Loc::getMessage('IMMOBILE_MODULE_NAME');
		$this->MODULE_DESCRIPTION = Loc::getMessage('IMMOBILE_MODULE_DESCRIPTION');
	}
	...
	{
		CopyDirFiles(
			$_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/immobile/install/components/',
		...
		CopyDirFiles(
			$_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/immobile/install/mobileapp/',
		...
		CopyDirFiles(
			$_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/immobile/install/js/',
	...
	public function doInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(
			Loc::getMessage('IMMOBILE_INSTALL_TITLE'),
	...
	public function doUninstall()
	{
		...
		{
			$APPLICATION->IncludeAdminFile(
				Loc::getMessage('IMMOBILE_UNINSTALL_TITLE'),
