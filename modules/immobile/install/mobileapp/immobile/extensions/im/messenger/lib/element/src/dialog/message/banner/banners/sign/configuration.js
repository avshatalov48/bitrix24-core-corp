	...
	const SignMetaData = {
		...
		[Await.inviteEmployeeSes]: {
			banner: {
				...
				imageName: ImageName.docAwaitSign,
				description: Loc.getMessage('IMMOBILE_MESSAGE_SIGN_INVITE_EMPLOYEE_SES_DESCRIPTION'),
				buttons: [
					{
		...
		[Await.inviteEmployeeSesWithInitiator]: {
			banner: {
				title: Loc.getMessage('IMMOBILE_MESSAGE_SIGN_INVITE_EMPLOYEE_SES_TITLE'),
				imageName: ImageName.docAwaitSign,
				description: Loc.getMessage('IMMOBILE_MESSAGE_SIGN_INVITE_EMPLOYEE_SES_DESCRIPTION_INITIATOR'),
				buttons: [
					{
		...
		[Success.doneEmployee]: {
			banner: {
				...
				imageName: ImageName.docSuccessSign,
				description: Loc.getMessage('IMMOBILE_MESSAGE_SIGN_DONE_EMPLOYEE_DESCRIPTION'),
				buttons: [
					{
		...
		[Success.doneEmployeeGosKey]: {
			banner: {
				...
				imageName: ImageName.docSuccessSign,
				description: Loc.getMessage('IMMOBILE_MESSAGE_SIGN_DONE_EMPLOYEE_GOS_KEY_DESCRIPTION'),
				buttons: [
					{
