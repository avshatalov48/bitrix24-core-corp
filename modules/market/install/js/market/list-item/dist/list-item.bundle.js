...
(function (exports,market_popupInstall,market_popupUninstall,ui_vue3_pinia,market_installStore,market_uninstallStore,market_ratingStore,ui_iconSet_api_vue,main_popup) {
	...
	var ListItem = {
	  ...
	  }, ui_vue3_pinia.mapActions(market_installStore.marketInstallState, ['showInstallPopup', 'setAppInfo'])), ui_vue3_pinia.mapActions(market_uninstallStore.marketUninstallState, ['deleteAction', 'setDeleteActionInfo'])), ui_vue3_pinia.mapActions(market_ratingStore.ratingStore, ['isActiveStar', 'getAppRating'])),
