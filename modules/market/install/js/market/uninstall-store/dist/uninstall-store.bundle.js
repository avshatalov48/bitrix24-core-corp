this.BX = this.BX || {};
(function (exports,ui_vue3_pinia,main_core_events) {
	'use strict';

	const marketUninstallState = ui_vue3_pinia.defineStore('market-uninstall', {
	  state: () => ({
	  ...
	  actions: {
	    ...
	    showUninstallConfirmPopup: function () {
	      this.popupDelete = new BX.PopupWindow('market_delete_confirm_popup_' + this.appCode, null, {
	    ...
	    uninstallApp: function () {
	      BX.ajax.runAction('market.Application.uninstall', {
	        data: {
	          code: this.appCode,
	        ...
	        if (result.error) {
	          ...
	          this.popupDelete.setButtons([new BX.PopupWindowButtonLink({
	          ...
	          if (!!result.sliderUrl) {
	            ...
	            if (this.refreshUri) {
	              main_core_events.EventEmitter.emit('market:refreshUri', {
	...
	exports.marketUninstallState = marketUninstallState;

}((this.BX.Market = this.BX.Market || {}),BX.Vue3.Pinia,BX.Event));
