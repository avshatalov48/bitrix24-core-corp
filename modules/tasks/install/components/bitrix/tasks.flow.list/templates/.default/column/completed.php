...
if (!function_exists('renderCompletedColumn'))
{
	function renderCompletedColumn(array $data, array $arResult, bool $isActive): string
	{
		...
		$onclick = $isEmpty ? '' : "BX.Tasks.Flow.Grid.showTaskQueue('{$flowId}', 'COMPLETED', this)";
