...
$MESS["KANBAN_POPUP_COLLAB_K_TEXT_1"] = "Kanban board shows collab tasks in columns, each of which representing a stage. All pending, in-progress and completed tasks are readily visible.";
$MESS["KANBAN_POPUP_COLLAB_K_TEXT_2"] = "Move the tasks through stages and keep track of the collab progress.";
$MESS["KANBAN_POPUP_COLLAB_K_TEXT_3"] = "Each collab can have its own kanban with custom stages.";
