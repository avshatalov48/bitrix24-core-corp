(function() {
	...
	BX.namespace('BX.Tasks.Graph');

	BX.Tasks.Graph.Circle = function(domNode, perimetr, progressBar) {
	...
	BX.Tasks.Graph.Circle.prototype =
	{
		...
		animateNumber: function() {
			...
			var interval = setInterval(function() {
				...
				i === Number(this.progressBar) ? clearInterval(interval) : null;
			}.bind(this), time);
		},
