...
namespace Bitrix\Tasks\Replicator\Template\Repetition\Time\Factory;

use Bitrix\Tasks\Replicator\Template\Parameter;
use Bitrix\Tasks\Replicator\Template\Repetition\Time\Enum\Day;
use Bitrix\Tasks\Replicator\Template\Repetition\Time\Enum\DayType;
use Bitrix\Tasks\Replicator\Template\Repetition\Time\Enum\Ordinal;
use Bitrix\Tasks\Replicator\Template\Repetition\Time\Enum\Period;
use Bitrix\Tasks\UI;
...
final class ExecutionTimeFactory
{
	...
	private function setReplicateParameter(Parameter $replicateParameter): self
	{
		$this->parsedReplicateParameter = CTaskTemplates::parseReplicationParams($replicateParameter->getData());
		return $this;
	}
