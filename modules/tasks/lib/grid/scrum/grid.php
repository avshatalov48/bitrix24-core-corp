...
class Grid extends \Bitrix\Tasks\Grid
{
	public function prepareHeaders(): array
	{
		$headers = [
			'ID' => [
				'id' => 'ID',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_ID'),
				'sort' => 'ID',
				'first_order' => 'desc',
				'editable' => false,
				'default' => false,
			...
			'NAME' => [
				'id' => 'NAME',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_PROJECT'),
				'sort' => 'NAME',
				'first_order' => 'desc',
				'editable' => false,
				'default' => true,
			...
			'ACTIVITY_DATE' => [
				'id' => 'ACTIVITY_DATE',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_ACTIVITY_DATE'),
				'sort' => 'ACTIVITY_DATE',
				'first_order' => 'desc',
				'editable' => false,
				'default' => true,
			...
			'EFFICIENCY' => [
				'id' => 'EFFICIENCY',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_EFFICIENCY'),
				'sort' => false,
				'editable' => false,
				'default' => true,
			],
			'MEMBERS' => [
				'id' => 'MEMBERS',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_MEMBERS'),
				'sort' => false,
				'editable' => false,
				'default' => true,
			],
			'ROLE' => [
				'id' => 'ROLE',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_ROLE'),
				'sort' => false,
				'editable' => false,
				'default' => true,
			],
			'TAGS' => [
				'id' => 'TAGS',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_TAGS'),
				'sort' => false,
				'editable' => false,
				'default' => true,
			...
			'OPENED' => [
				'id' => 'OPENED',
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_TYPE'),
				'sort' => 'OPENED',
				'first_order' => 'desc',
				'editable' => false,
				'default' => true,
			...
			'PROJECT_DATE_START' => [
				...
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_DATE_START'),
			...
			'PROJECT_DATE_FINISH' => [
				...
				'name' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_HEADER_DATE_FINISH'),
	...
	public function prepareGroupActions(): array
	{
		$actions = [
			[
				...
				'ID' => 'addToArchive',
				'TEXT' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_GROUP_ACTION_ADD_TO_ARCHIVE'),
				'ICON' => '',
				'ONCHANGE' => [
					[
			...
			[
				...
				'TEXT' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_GROUP_ACTION_REMOVE_FROM_ARCHIVE'),
				'ICON' => '',
				'ONCHANGE' => [
					[
						'ACTION' => Panel\Actions::CALLBACK,
			...
			[
				'TYPE' => Panel\Types::BUTTON,
				'ID' => 'delete',
				'TEXT' => Loc::getMessage('TASKS_GRID_SCRUM_GRID_GROUP_ACTION_DELETE'),
				'ICON' => '',
				'ONCHANGE' => [
					[
						'ACTION' => Panel\Actions::CALLBACK,
