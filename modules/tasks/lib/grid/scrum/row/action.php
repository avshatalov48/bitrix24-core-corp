...
class Action
{
	...
	public function prepare(): array
	{
		...
		{
			$actions[] = [
				'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_PIN'),
		...
		{
			$actions[] = [
				'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_UNPIN'),
				'onclick' => "BX.Tasks.Projects.ActionsController.doAction('unpin', {$groupId})",
			];
		}

		$actions[] = [
			'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_OPEN'),
		...
		if ($user['IS_OWNER'] === 'Y')
		{
			...
			{
				$actions[] = [
					'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_ADD_TO_ARCHIVE'),
			...
			{
				$actions[] = [
					'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_REMOVE_FROM_ARCHIVE'),
					'onclick' => "BX.Tasks.Projects.ActionsController.doAction('removeFromArchive', {$groupId})",
				];
			}

			$actions[] = [
				'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_DELETE'),
				'href' => \CComponentEngine::makePathFromTemplate(
		...
		if (!$isMember)
		{
			$actionRequest = ['text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_REQUEST')];
		...
		)
		{
			if ($user['IS_ACCESS_REQUESTING'] === 'Y')
			{
				...
				{
					$actions[] = [
						'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_CANCEL_REQUEST'),
				...
				{
					$actions[] = [
						'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_ACCEPT_REQUEST'),
						'onclick' => "BX.Tasks.Projects.ActionsController.sendAcceptRequest({$userGroupRelationId}, '{$requestPath}')",
					];
					$actions[] = [
						'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_DENY_REQUEST'),
			...
			{
				$actions[] = [
					'text' => Loc::getMessage('TASKS_GRID_SCRUM_ROW_ACTION_LEAVE'),
					'href' => \CComponentEngine::makePathFromTemplate(
