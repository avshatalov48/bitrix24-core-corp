 ...
 * @method static \Bitrix\Disk\Document\Models\RestrictionLog createObject($setDefaultValues = true)
 * @method static \Bitrix\Disk\Document\Models\EO_RestrictionLog_Collection createCollection()
 * @method static \Bitrix\Disk\Document\Models\RestrictionLog wakeUpObject($row)
 * @method static \Bitrix\Disk\Document\Models\EO_RestrictionLog_Collection wakeUpCollection($rows)
 */
class RestrictionLogTable extends DataManager
{
	...
	{
		return 'b_disk_document_restriction_log';
	}
