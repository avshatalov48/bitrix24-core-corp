...
class MessageStatus
{
	...
	{
		return new MessageStatus(self::CODE_SENDING);
	}

	public static function sent(): self
	{
		return new MessageStatus(self::CODE_SENT);
	}

	public static function delivered(): self
	{
		return new MessageStatus(self::CODE_DELIVERED);
	}

	public static function read(): self
	{
		return new MessageStatus(self::CODE_READ);
	}

	public static function failed(): self
	{
		return new MessageStatus(self::CODE_FAILED);
	}
