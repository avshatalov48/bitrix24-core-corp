...
namespace Bitrix\Booking\Internals\Recurr;

use Bitrix\Booking\Internals\Recurr\Exception\InvalidArgument;
use Bitrix\Booking\Internals\Recurr\Exception\InvalidRRule;
