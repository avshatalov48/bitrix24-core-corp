...
use Bitrix\Booking\Internals\Recurr\DateExclusion;
use Bitrix\Booking\Internals\Recurr\DateInclusion;
use Bitrix\Booking\Internals\Recurr\DateUtil;
use Bitrix\Booking\Internals\Recurr\Exception\InvalidWeekday;
use Bitrix\Booking\Internals\Recurr\Frequency;
use Bitrix\Booking\Internals\Recurr\Recurrence;
use Bitrix\Booking\Internals\Recurr\Rule;
use Bitrix\Booking\Internals\Recurr\Time;
use Bitrix\Booking\Internals\Recurr\Weekday;
...
class ArrayTransformer
{
     ...
     */
    public function transform(Rule $rule, ConstraintInterface $constraint = null, $countConstraintFailures = true): array
    {
