...
use Bitrix\Booking\Internals\Journal\EventProcessor\Counter\CounterEventProcessor;
use Bitrix\Booking\Internals\Journal\EventProcessor\PushPull\PushPullEventProcessor;
use Bitrix\Booking\Internals\Journal\EventProcessor\Booking\BookingEventProcessor;
use Bitrix\Booking\Internals\Journal\EventProcessor\Resource\ResourceEventProcessor;
...
final class JournalService implements JournalServiceInterface
{
	...
	private function enableJob(): void
	{
		...
		$application && $application->addBackgroundJob(
			['\Bitrix\Booking\Internals\Journal\JournalService', 'process'],
			[],
