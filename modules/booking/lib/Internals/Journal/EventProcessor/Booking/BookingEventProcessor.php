...
namespace Bitrix\Booking\Internals\Journal\EventProcessor\Booking;

use Bitrix\Booking\Integration\Im\Chat;
...
class BookingEventProcessor implements EventProcessor
{
	...
	{
		// event -> command
		$command = Booking\AddCommand::mapFromArray($journalEvent->data);
	...
	{
		// event -> command
		$command = Booking\UpdateCommand::mapFromArray($journalEvent->data);
