...
use Bitrix\Booking\Integration\Booking\Message\MessageBodyBased;
...
class BookingMessageBodyBasedCreator extends BookingMessageCreator
{
	protected function createInfoMessage(): MessageBodyBased|null
	{
		...
		return (new MessageBodyBased($this->messageSender, NotificationType::Info))
	...
	protected function createConfirmationMessage(): MessageBodyBased|null
	{
		...
		return (new MessageBodyBased($this->messageSender, NotificationType::Confirmation))
			->setMessageBody($messageBody);
	}
	...
	protected function createRemindMessage(): MessageBodyBased|null
	{
		...
		return (new MessageBodyBased($this->messageSender, NotificationType::Reminder))
			->setMessageBody($messageBody);
	}
	...
	protected function createFeedbackMessage(): MessageBodyBased|null
	{
		...
		return (new MessageBodyBased($this->messageSender, NotificationType::Feedback))
			->setMessageBody($messageBody);
	}
	...
	protected function createDelayedMessage(): MessageBodyBased|null
	{
		...
		return (new MessageBodyBased($this->messageSender, NotificationType::Delayed))
			->setMessageBody($messageBody);
	}
