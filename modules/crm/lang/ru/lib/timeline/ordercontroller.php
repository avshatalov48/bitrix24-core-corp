...
$MESS["CRM_ORDER_VIEWED"] = "Заказ просмотрен";
$MESS["CRM_ORDER_VIEWED_TITLE"] = "Клиент просмотрел";
...
$MESS["CRM_ORDER_VIEWED_TITLE_2"] = "Клиент перешел на страницу заказа";
$MESS["CRM_ORDER_VIEWED_HTML_TITLE_2"] = "№#ORDER_ID# от #DATE# на сумму #SUM#";
$MESS["CRM_ORDER_SENT"] = "Отправлен заказ";
