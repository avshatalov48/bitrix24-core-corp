...
final class ExcludeChildAction extends GroupChildAction
{
	...
	{
		return (string)Loc::getMessage('CRM_GRID_PANEL_GROUP_ACTION_EXCLUDE');
	}
	...
	protected function getOnchange(): Onchange
	{
		...
		$callback =
			(new Event('BatchManager:executeExclusion'))
