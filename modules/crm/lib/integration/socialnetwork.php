		...
		return new EventResult(
			...
			array(
				'lang_additional' => array(
					...
					'SONET_EXT_COMMENTAUX_CREATE_TASK_CRM_LOG_INVOICE' => Loc::getMessage('SONET_EXT_COMMENTAUX_CREATE_TASK_CRM_LOG_INVOICE'),
					...
					'SONET_COMMENTAUX_JS_CREATETASK_POST_CRM_LOG_INVOICE' => Loc::getMessage('SONET_COMMENTAUX_CREATETASK_POST_CRM_LOG_INVOICE'),
