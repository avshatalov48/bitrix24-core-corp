...
class TaskAccompliceAdded extends LogMessage
{
	use LogMessageTrait;
	...
	{
		return Loc::getMessage('TASKS_ON_TASK_ACCOMPLICE_ADDED_TITLE');
	}
	...
	public function getContentBlocks(): ?array
	{
		...
		return [
			...
			'client' => $this->getUserBlock($model, Loc::getMessage('TASKS_ON_TASK_ACCOMPLICE_ADDED_CHANGE')),
		];
	}
}