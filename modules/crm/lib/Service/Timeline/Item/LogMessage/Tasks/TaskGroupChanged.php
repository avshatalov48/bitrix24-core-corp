...
class TaskGroupChanged extends LogMessage
{
	use LogMessageTrait;
	...
	{
		return Loc::getMessage('TASKS_ON_TASK_GROUP_CHANGED_TITLE');
	}
	...
	public function getContentBlocks(): ?array
	{
		...
		return [
			...
			'client' => $this->getUserBlock($model, Loc::getMessage('TASKS_ON_TASK_GROUP_CHANGED_CHANGE')),
		];
	}
}