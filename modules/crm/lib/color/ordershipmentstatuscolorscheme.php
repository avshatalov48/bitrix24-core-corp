...
class OrderShipmentStatusColorScheme extends PhaseColorScheme
{
	...
	{
		return 'CONFIG_STATUS_ORDER_SHIPMENT_STATUS';
	}
	/**
	 * Get Status Names
	 * @return array
	...
	public static function getStatusNames()
	{
		if(self::$names === null)
		{
			self::$names = array_keys(Crm\Order\DeliveryStatus::getListInCrmFormat());
		}
		return self::$names;
	}
	/**
	...
	{
		$options = array();
		$semanticID = Crm\Order\DeliveryStatus::getSemanticID($statusID);
	...
	/**
	 * Get current scheme
	 * @return OrderShipmentStatusColorScheme
	...
	public static function getCurrent()
	{
		...
		{
			self::$current = new OrderShipmentStatusColorScheme();
