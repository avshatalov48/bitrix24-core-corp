...
use Bitrix\Crm\Order\Matcher\Internals\QueueTable;
...
class ResponsibleQueue
{
	...
	CONST OPTION_LAST_NAME = 'crm_persontype_resp_queue';
	public $list = array();
	public $lastId = null;
	...
	public function loadList()
	{
		$listDb = QueueTable::getList(array(
			...
			'filter' => array('=PERSON_TYPE_ID' => $this->entityId),
			'cache' => array('ttl' => 0)
		));
