 ...
 * @method static EO_CompanyActivitySumStatistics_Result getByPrimary($primary, array $parameters = [])
 * @method static EO_CompanyActivitySumStatistics_Result getById($id)
 * @method static EO_CompanyActivitySumStatistics_Result getList(array $parameters = [])
