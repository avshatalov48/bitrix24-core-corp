 ...
 * @method static EO_CompanyActivityMarkStatistics_Result getByPrimary($primary, array $parameters = [])
 * @method static EO_CompanyActivityMarkStatistics_Result getById($id)
 * @method static EO_CompanyActivityMarkStatistics_Result getList(array $parameters = [])
