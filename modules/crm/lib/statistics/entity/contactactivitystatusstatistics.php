...
/**
 * Class ContactActivityStatusStatisticsTable
 *
 * DO NOT WRITE ANYTHING BELOW THIS
 *
 * <<< ORMENTITYANNOTATION
 * @method static EO_ContactActivityStatusStatistics_Query query()
 * @method static EO_ContactActivityStatusStatistics_Result getByPrimary($primary, array $parameters = [])
 * @method static EO_ContactActivityStatusStatistics_Result getById($id)
 * @method static EO_ContactActivityStatusStatistics_Result getList(array $parameters = [])
