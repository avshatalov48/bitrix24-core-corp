 ...
 * @method static EO_ContactActivitySumStatistics_Result getByPrimary($primary, array $parameters = [])
 * @method static EO_ContactActivitySumStatistics_Result getById($id)
 * @method static EO_ContactActivitySumStatistics_Result getList(array $parameters = [])
