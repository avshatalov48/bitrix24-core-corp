;(function()
{
	...
	BX.Crm.Report.ManagersRatingGrid = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("crm-report-managersrating-grid-value-clickable");
	...
	BX.Crm.Report.ManagersRatingGrid.bindEvents();
})();
