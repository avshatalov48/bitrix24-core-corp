;(function()
{
	...
	BX.Crm.Report.RegularCustomersGrid = {
		gridId: null,
		boardId: null,
		widgetId: null,
		init: function(options)
		{
			...
			var clickableElements = document.getElementsByClassName("crm-report-regularcustomers-grid-value-clickable");
	...
	BX.Crm.Report.RegularCustomersGrid.bindEvents();
})();
