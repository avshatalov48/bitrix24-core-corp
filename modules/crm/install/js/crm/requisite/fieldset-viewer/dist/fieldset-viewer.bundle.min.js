this.BX=this.BX||{};this.BX.Crm=this.BX.Crm||{};(function(e,t,i,s,n,r,o){"use strict";let l=e=>e,a,d,c,u,h,E,v,g;class p extends i.EventEmitter{constructor(e={}){super();this.cache=new t.Cache.MemoryCache;this.endpoint="crm.api.fieldset.load";this.setEventNamespace("BX.Crm.Requisite.FieldsetViewer");this.subscribeFromOptions((e==null?void 0:e.events)||{});this.setOptions(e);t.Event.bind(e.bindElement,"click",this.onBindElementClick.bind(this))}setData(e){this.cache.set("data",e)}setEndpoint(e){this.endpoint=e;return this}getData(){return this.cache.get("data",{})}load(){return new Promise(((e,t)=>{var i,s;const{entityTypeId:n,entityId:r,fieldListEditorOptions:o}=this.getOptions();const l=(i=o==null?void 0:(s=o.fieldsPanelOptions)==null?void 0:s.presetId)!=null?i:null;BX.ajax.runAction(this.endpoint,{json:{entityTypeId:n,entityId:r,presetId:l}}).then((t=>{e(t.data)})).catch((e=>{t(e.errors)}))}))}setOptions(e){this.cache.set("options",{...e})}getOptions(){return this.cache.get("options")}getPopup(){return this.cache.remember("popup",(()=>{const e=this.getOptions();return new s.Popup({bindElement:e.bindElement,autoHide:false,width:570,height:478,className:"crm-requisite-fieldset-viewer",noAllPaddings:true,...t.Type.isPlainObject(e==null?void 0:e.popupOptions)?e==null?void 0:e.popupOptions:{},events:{onClose:()=>{this.emit("onClose",{changed:this.getIsChanged()});this.setIsChanged(false)}}})}))}setIsChanged(e){this.cache.set("isChanged",t.Text.toBoolean(e))}getIsChanged(){return this.cache.get("isChanged",false)}getLoader(){return this.cache.remember("loader",(()=>new n.Loader))}show(){const e=this.getPopup();t.Dom.clean(e.getContentContainer());void this.getLoader().show(e.getContentContainer());this.load().then((t=>{this.setData({...t});e.setContent(this.createPopupContent(t))})).catch((e=>{this.emit("onFieldSetLoadError",{requestErrors:e})}));e.show()}hide(){this.getPopup().close()}onBindElementClick(e){e.preventDefault();this.show()}createPopupContent(e){return t.Tag.render(a||(a=l`
		...
		`),e.map((e=>this.createListItem(e))))}createListItem(e){var i;const s=(()=>{var i;if(t.Type.isStringFilled(e==null?void 0:(i=e.editing)==null?void 0:i.url)){const i=()=>{var t;BX.SidePanel.Instance.open(e==null?void 0:(t=e.editing)==null?void 0:t.url,{cacheable:false,events:{onClose:()=>{this.show()}}});this.setIsChanged(true)};return t.Tag.render(h||(h=l`
					<span 
		...
		`),t.Text.encode(e==null?void 0:e.label),t.Text.encode(n),s)}createCloseButton(){return this.cache.remember("closeButton",(()=>{const e=()=>{this.hide()};return t.Tag.render(v||(v=l`
				<div 
					...
					onclick="${0}"
				></div>
			`),e)}))}getFieldListEditor(){return this.cache.remember("fieldListEditor",(()=>{const e=this.getOptions();return new o.ListEditor({setId:this.getData().id,title:t.Loc.getMessage("CRM_REQUISITE_FIELDSET_VIEWER__SET_EDITOR_TITLE_MSGVER_1"),editable:{label:{label:t.Loc.getMessage("CRM_REQUISITE_FIELDSET_VIEWER__SET_EDITOR_NAME_LABEL"),type:"string"},required:{label:t.Loc.getMessage("CRM_REQUISITE_FIELDSET_VIEWER__SET_EDITOR_REQUIRED_LABEL"),type:"checkbox"}},autoSave:false,cacheable:false,events:{onSave:()=>this.show()},fieldsPanelOptions:{hideVirtual:1,...t.Type.isPlainObject(e.fieldsPanelOptions)?e.fieldsPanelOptions:{}},...t.Type.isPlainObject(e.fieldListEditorOptions)?e.fieldListEditorOptions:{}})}))}getEditButton(){return this.cache.remember("editButton",(()=>new r.Button({text:t.Loc.getMessage("CRM_REQUISITE_FIELDSET_VIEWER_EDIT_BUTTON_LABEL_MSGVER_1"),color:r.Button.Color.LIGHT_BORDER,icon:r.Button.Icon.EDIT,size:r.Button.Size.SMALL,round:true,events:{click:this.onEditButtonClick.bind(this)}})))}onEditButtonClick(){this.getFieldListEditor().showSlider();this.setIsChanged(true)}getFooterLayout(){return this.cache.remember("footerLayout",(()=>t.Tag.render(g||(g=l`
