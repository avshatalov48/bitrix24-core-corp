...
(function (exports,ui_sidepanelContent,main_core,main_core_events,crm_form_type,crm_form_fields_mapper,ui_alerts,ui_buttons,ui_dropdown,main_core_ajax,main_loader,seo_ads_login,seo_ads_client_selector) {
	...
	function _onLogedIn2(options) {
	  ...
	  main_core_ajax.ajax.runAction('crm.api.form.getDict', {
	    ...
	    _this5.dictionary.integration = data.integration;

	    if (/.group/.test(options.engine || '')) {
	      _classPrivateMethodGet(_this5, _renderPageSelector, _renderPageSelector2).call(_this5);
	    } else {
	      _classPrivateMethodGet(_this5, _renderProfileSelector, _renderProfileSelector2).call(_this5);
	    }
	  });
	}
	...
	function _logoutProfile2() {
	  ...
	  main_core_ajax.ajax.runAction('crm.api.ads.leadads.service.logout', {
	    ...
	    babelHelpers.classPrivateFieldSet(_this6, _adAccounts, null);
	    _this6.getProvider().profile = null;
	...
	function _logoutGroup2() {
	  ...
	  return main_core_ajax.ajax.runAction('crm.api.ads.leadads.service.logoutGroup', {
	    ...
	    _this7.getProvider().group.hasAuth = false;

	    _classPrivateMethodGet(_this7, _renderPageSelector, _renderPageSelector2).call(_this7);
	  });
	}
	...
	function _renderProfileSelector2() {
	  ...
	  if (!babelHelpers.classPrivateFieldGet(this, _profileContainer)) {
	    babelHelpers.classPrivateFieldSet(this, _profileContainer, main_core.Tag.render(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["<div></div>"]))));
	  }
	  ...
	  if (!provider.profile) {
	    ...
	    babelHelpers.classPrivateFieldGet(this, _profileContainer).appendChild(new ui_buttons.Button({
	      ...
	      color: ui_buttons.ButtonColor.PRIMARY,
	      onclick: function onclick() {
	        return _classPrivateMethodGet(_this8, _loginProfile, _loginProfile2).call(_this8);
	      }
	    }).render());
	    return babelHelpers.classPrivateFieldGet(this, _profileContainer);
	  }

	  babelHelpers.classPrivateFieldGet(this, _profileContainer).appendChild(main_core.Tag.render(_templateObject3 || (_templateObject3 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<div>\n\t\t\t\t<div class=\"crm-ads-conversion-block\">\n\t\t\t\t\t<div class=\"crm-ads-conversion-social crm-ads-conversion-social-facebook\">\n\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t<div\n\t\t\t\t\t\t\t\tclass=\"crm-ads-conversion-social-avatar-icon\"\n\t\t\t\t\t\t\t\tstyle=\"background-image: url(", ")\"\n\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"crm-ads-conversion-social-user\">\n\t\t\t\t\t\t\t<a\n\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t\ttarget=\"_top\"\n\t\t\t\t\t\t\t\tclass=\"crm-ads-conversion-social-user-link\"\n\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"crm-ads-conversion-social-shutoff\">\n\t\t\t\t\t\t\t<span\n\t\t\t\t\t\t\t\tclass=\"crm-ads-conversion-social-shutoff-link\"\n\t\t\t\t\t\t\t\tonclick=\"", "\"\n\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"])), main_core.Tag.safe(_templateObject4 || (_templateObject4 = babelHelpers.taggedTemplateLiteral(["", ""])), provider.profile.picture), provider.profile.url ? 'href="' + main_core.Tag.safe(_templateObject5 || (_templateObject5 = babelHelpers.taggedTemplateLiteral(["", ""])), provider.profile.url) + '"' : "", main_core.Tag.safe(_templateObject6 || (_templateObject6 = babelHelpers.taggedTemplateLiteral(["", ""])), provider.profile.name), _classPrivateMethodGet(this, _logoutProfile, _logoutProfile2).bind(this), main_core.Loc.getMessage('CRM_FORM_INTEGRATION_JS_LOGOUT_BTN')));
	...
	function _renderPageSelector2() {
	  ...
	  if (!babelHelpers.classPrivateFieldGet(this, _pagesContainer)) {
	    babelHelpers.classPrivateFieldSet(this, _pagesContainer, main_core.Tag.render(_templateObject7 || (_templateObject7 = babelHelpers.taggedTemplateLiteral(["<div></div>"]))));
	  }
	  ...
	  if (!babelHelpers.classPrivateFieldGet(this, _adAccounts)) {
	    ...
	    main_core_ajax.ajax.runAction('crm.api.ads.leadads.account.getAccounts', {
	      ...
	      babelHelpers.classPrivateFieldSet(_this9, _adAccounts, response.data.accounts.map(function (item) {
	        return {
	          id: item.id + '',
	          name: item.name + ''
	        };
	      ...
	      _classPrivateMethodGet(_this9, _renderPageSelector, _renderPageSelector2).call(_this9);
	    });
	  ...
	  pagesDropdown.subscribe('onChange', function () {
	    _classPrivateMethodGet(_this9, _setPageId, _setPageId2).call(_this9, pagesDropdown.getValue());
	  });
	  var container = main_core.Tag.render(_templateObject8 || (_templateObject8 = babelHelpers.taggedTemplateLiteral(["<div class=\"crm-form-integration-page-container\"></div>"])));
	  var selectorContainer = main_core.Tag.render(_templateObject9 || (_templateObject9 = babelHelpers.taggedTemplateLiteral(["<div class=\"crm-form-integration-page-selector\"></div>"])));
	  ...
	  if (hasAuthGroup && id && id !== group.groupId) {
	    ...
	    var groupConnectBtn = new ui_buttons.Button({
	      ...
	      onclick: function onclick() {
	        ...
	        _classPrivateMethodGet(_this9, _logoutGroup, _logoutGroup2).call(_this9).then(function () {
	  ...
	  if (id && group.isAuthUsed && !group.hasAuth) {
	    var _groupConnectBtn = new ui_buttons.Button({
	      ...
	      className: '',
	      onclick: function onclick() {
	        return _classPrivateMethodGet(_this9, _loginGroup, _loginGroup2).call(_this9);
	      }
	    });
	...
	function _renderFormSelector2() {
	  ...
	  if (!babelHelpers.classPrivateFieldGet(this, _formsContainer)) {
	    babelHelpers.classPrivateFieldSet(this, _formsContainer, main_core.Tag.render(_templateObject10 || (_templateObject10 = babelHelpers.taggedTemplateLiteral(["<div></div>"]))));
	  }
	  ...
	  if (!babelHelpers.classPrivateFieldGet(this, _adForms)) {
	    ...
	    main_core_ajax.ajax.runAction('crm.api.ads.leadads.form.list', {
	      ...
	      babelHelpers.classPrivateFieldSet(_this10, _adForms, response.data.forms.map(function (item) {
	        item.id += '';
	        return item;
	      }));

	      _classPrivateMethodGet(_this10, _renderFormSelector, _renderFormSelector2).call(_this10);
	    })["catch"](function (response) {
	      babelHelpers.classPrivateFieldSet(_this10, _adFormsErrors, response.errors);
	      babelHelpers.classPrivateFieldSet(_this10, _adForms, []);
	  ...
	  formsDropdown.subscribe('onChange', function () {
	    ...
	    _this10.getCase().form.id = formId;
	    _this10.getCase().form.name = (_this10.getAdForm(formId) || {}).name;
	    _this10.getCase().fieldsMapping = [];

	    _this10.emit('change');

	    _classPrivateMethodGet(_this10, _renderMapper, _renderMapper2).call(_this10);
	  });
	...
	function _renderLoader2() {
	  var container = main_core.Tag.render(_templateObject11 || (_templateObject11 = babelHelpers.taggedTemplateLiteral(["<div style=\"position: relative; min-height: 100px;\"></div>"])));
	...
	function _renderMapper2() {
	  ...
	  if (!babelHelpers.classPrivateFieldGet(this, _mapperContainer)) {
	    babelHelpers.classPrivateFieldSet(this, _mapperContainer, main_core.Tag.render(_templateObject12 || (_templateObject12 = babelHelpers.taggedTemplateLiteral(["<div></div>"]))));
	  }
	  ...
	  var mappingMessageContainer = main_core.Tag.render(_templateObject13 || (_templateObject13 = babelHelpers.taggedTemplateLiteral(["<div style=\"margin-bottom: 40px\"></div>"])));
	  new ui_alerts.Alert({
	    color: ui_alerts.Alert.Color.PRIMARY,
	  ...
	  var mapper = new crm_form_fields_mapper.Mapper({
	    ...
	    map: this.getAdForm().fields.map(function (field) {
	      var outputCode = _this11.getCase().fieldsMapping.filter(function (item) {
	      ...
	      if (!outputCode) {
	        outputCode = _this11.getProvider().defaultMapping.filter(function (item) {
	  ...
	  var emitChangeEvent = function emitChangeEvent() {
	    var eventFields = [];
	    _this11.getCase().fieldsMapping = mapper.getMap().map(function (item) {
	      if (item.outputCode) {
	        eventFields.push({
