	...
	var EntityEditorBankDetailsField = /*#__PURE__*/function (_EntityEditorFieldset) {
	  ...
	  babelHelpers.createClass(EntityEditorBankDetailsField, [{
	    ...
	    value: function prepareEntityEditorContext() {
	      var context = babelHelpers.get(babelHelpers.getPrototypeOf(EntityEditorBankDetailsField.prototype), "prepareEntityEditorContext", this).call(this);
	      var schemeData = this.getSchemeElement().getData();
	      var resolverProperty = BX.prop.getObject(schemeData, "resolverProperty", null);
	      if (resolverProperty) {
