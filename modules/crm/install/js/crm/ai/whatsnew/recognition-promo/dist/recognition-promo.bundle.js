	...
	function _renderConnectTelephonyButton2() {
	  const button = new ui_buttons.Button({
	    ...
	    onclick: btn => {
	      ...
	      if ((_babelHelpers$classPr2 = babelHelpers.classPrivateFieldLooseBase(this, _events)[_events]) != null && _babelHelpers$classPr2.onClickOnConnectButton) {
	...
	function _renderRemindLaterButton2() {
	  const button = new ui_buttons.Button({
	    ...
	    onclick: btn => {
	      ...
	      if ((_babelHelpers$classPr3 = babelHelpers.classPrivateFieldLooseBase(this, _events)[_events]) != null && _babelHelpers$classPr3.onClickOnRemindLaterButton) {
