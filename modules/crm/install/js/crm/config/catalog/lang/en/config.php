...
$MESS["CRM_CFG_C_SETTINGS_COST_PRICE_CALCULATION_MODE_HINT"] = "There are two costing methodologies: FIFO where the item acquired first is sold first; and average cost price. This will affect the gross profit values.";
$MESS["CRM_CFG_C_SETTINGS_COST_PRICE_CALCULATION_MODE_MSGVER_1"] = "Select costing method to use when selling goods:";
$MESS["CRM_CFG_C_SETTINGS_COST_PRICE_CHANGE_MODE_INFO_MSGVER_1"] = "You will have to restart Inventory Management to change costing method.";
$MESS["CRM_CFG_C_SETTINGS_COST_PRICE_CHANGE_MODE_WARNING_MSGVER_1"] = "You will have to restart Inventory Management to change costing method. This may require that you will have to create all of the inventory objects again.";
...
$MESS["CRM_CFG_C_SETTINGS_PRODUCTS_SETTINGS_DEFAULT_VAT_HINT"] = "Tax rate will be added to the product price automatically when the product is created.";
