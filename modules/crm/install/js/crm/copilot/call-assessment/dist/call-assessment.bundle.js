...
(function (exports,ui_vue3,ui_buttons,ui_iconSet_main,ui_textEditor,ui_notification,ui_bbcode_parser,main_core,ui_infoHelper) {
	'use strict';
	...
	class CallAssessment$1 {
	  constructor(containerId, _params = {}) {
	    var _params$config$readOn, _params$config, _params$config2, _params$config$isCopy, _params$config3, _params$config$baasSe, _params$config4;
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _app)[_app] = ui_vue3.BitrixVue.createApp(CallAssessment, {
	      textEditor: babelHelpers.classPrivateFieldLooseBase(this, _getTextEditor)[_getTextEditor](_params.data, (_params$config2 = _params.config) != null ? _params$config2 : {}),
	      settings: {
	        readOnly: babelHelpers.classPrivateFieldLooseBase(this, _isReadOnly)[_isReadOnly],
	        isCopy: (_params$config$isCopy = (_params$config3 = _params.config) == null ? void 0 : _params$config3.isCopy) != null ? _params$config$isCopy : false,
	        baas: (_params$config$baasSe = (_params$config4 = _params.config) == null ? void 0 : _params$config4.baasSettings) != null ? _params$config$baasSe : false
	      },
	      params: {
	        data: _params.data,
	...
	function _getTextEditor2({
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _textEditor)[_textEditor] = new ui_textEditor.BasicEditor({
	    ...
	    toolbar: ['bold', 'italic', 'underline', 'strikethrough', '|', 'numbered-list', 'bulleted-list', 'copilot'],
	    floatingToolbar: [],
...
}((this.BX.Crm.Copilot = this.BX.Crm.Copilot || {}),BX.Vue3,BX.UI,BX,BX.UI.TextEditor,BX,BX.UI.BBCode,BX,BX.UI));
