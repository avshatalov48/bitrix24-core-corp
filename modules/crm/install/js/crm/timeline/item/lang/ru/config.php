...
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_POPUP_TITLE"] = "Подписание";
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_DO_USE_PREVIOUS"] = "Этот шаблон использовался %CREATED_AT% для сделки \"%TITLE%\", ответственный \"%INITIATOR%\". Использовать снова?";
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_OLD_BUTTON"] = "Использовать снова";
$MESS["CRM_TIMELINE_ITEM_ACTIVITY_NEW_BUTTON"] = "Другой шаблон";
