	...
	class List extends main_core_events.EventEmitter {
	  ...
	  render() {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _link)[_link] || this.isLinkObtainable) {
	      this.layout.link = main_core.Tag.render(_t2 || (_t2 = _`<input type="text" class="crm__channel-selector--footer-link-hidden" value="${0}" />`), main_core.Text.encode(babelHelpers.classPrivateFieldLooseBase(this, _link)[_link])); // class="crm__channel-selector--footer --disabled"
