...
(function (exports,main_core_events,ui_vue3,main_popup,main_core,ui_notification,main_date,crm_timeline_tools) {
	'use strict';
	...
	const TodoEditor = {
	  ...
	  computed: {
	    ...
	    exampleAdditionalButtons() {
	      return []; //return exampleAdditionalButtons;
	    }
	  ...
	  methods: {
	    ...
	    onTextareaInput(e) {
	      main_core.Dom.style(e.target, 'height', 'auto');
	      main_core.Dom.style(e.target, 'height', `${e.target.scrollHeight}px`);
	...
	let TodoEditor$1 = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(TodoEditor$$1, [{
	    ...
	    value: function save() {
	      ...
	      const userData = babelHelpers.classPrivateFieldGet(this, _layoutComponent).getData(); // wrap BX.Promise in native js promise
...
}((this.BX.Crm.Activity = this.BX.Crm.Activity || {}),BX.Event,BX.Vue3,BX.Main,BX,BX,BX.Main,BX.Crm.Timeline));
