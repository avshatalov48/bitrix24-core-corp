/**
 * @module call/calls-card/card-content/elements/collapse-button
 */
jn.define('call/calls-card/card-content/elements/collapse-button', (require, exports, module) => {
	...
	const CollapseButton = ({onRollUp}) => {
		return View(
			...
			Text({
				text: BX.message('MOBILE_CALLS_CARD_COLLAPSE_BUTTON_TEXT'),
				style: {
					fontSize: 14,
					color: '#787878',
					marginRight: 11,
