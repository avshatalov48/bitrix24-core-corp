...
CREATE TABLE IF NOT EXISTS b_timeman_monitor_app (
    ID INT NOT NULL AUTO_INCREMENT,
    CODE VARCHAR(32) NOT NULL,
    NAME VARCHAR(2000) NOT NULL,
    CLASSIFIER_ID INT DEFAULT NULL,
    PRIMARY KEY (ID)
);

CREATE TABLE IF NOT EXISTS b_timeman_monitor_site (
    ID INT NOT NULL AUTO_INCREMENT,
    CODE VARCHAR(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS b_timeman_monitor_user_log (
    ...
    PRIMARY KEY (DATE_LOG, USER_ID, CODE)
);

CREATE TABLE IF NOT EXISTS b_timeman_monitor_user_page (
	DATE_LOG DATE NOT NULL,
    USER_ID INT NOT NULL,
    DESKTOP_CODE VARCHAR(32) NOT NULL,
    CODE VARCHAR(32) NOT NULL,
    ...
    SITE_CODE VARCHAR(32) DEFAULT NULL,
    SITE_URL VARCHAR(2000) DEFAULT NULL,
    SITE_TITLE VARCHAR(2000) DEFAULT NULL,
    TIME_SPEND INT NOT NULL DEFAULT 0,
    PRIMARY KEY (DATE_LOG, USER_ID, CODE, PAGE_CODE)
);

CREATE TABLE IF NOT EXISTS b_timeman_monitor_group (
	ID INT NOT NULL AUTO_INCREMENT,
	NAME TEXT NOT NULL,
	CODE VARCHAR(100) NOT NULL,
	COLOR CHAR(7) DEFAULT NULL,
	DEFAULT_GROUP CHAR(1) DEFAULT 'N',
	HIDDEN CHAR(1) DEFAULT 'N',
	PRIMARY KEY (ID)
);

CREATE TABLE IF NOT EXISTS b_timeman_monitor_group_access (
	...
	PRIMARY KEY (DEPARTMENT_ID, ENTITY_TYPE, ENTITY_ID)
);

CREATE TABLE IF NOT EXISTS b_timeman_monitor_user_access (
	ID INT NOT NULL AUTO_INCREMENT,
	GROUP_CODE VARCHAR(100) NOT NULL,
	USER_ID INT NOT NULL,
	ENTITY_TYPE VARCHAR(100) NOT NULL,
