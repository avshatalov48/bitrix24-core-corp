...
$MESS['BIC_CRM_MENU_USAGE_STAT'] = 'Использование';
$MESS['BIC_CRM_MENU_CONNECT'] = 'Подключение';
$MESS['BIC_CRM_MENU_DASHBOARD_MANAGE'] = 'Управление отчётами';
$MESS['BIC_CRM_MENU_REPORT_TEMPLATES'] = 'Готовые шаблоны отчётов';
