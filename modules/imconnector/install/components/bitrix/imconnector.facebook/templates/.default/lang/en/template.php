...
$MESS["IMCONNECTOR_COMPONENT_FACEBOOK_TO_CONNECT_HUMAN_AGENT"] = "Extend messaging window from 24 hours to 7 days";
$MESS["IMCONNECTOR_COMPONENT_FACEBOOK_TO_CONNECT_HUMAN_AGENT_DESCRIPTION"] = "Note that Facebook does not allow sending ads (including discounts, coupons) or automated messages to the customers once the 24-hour window has expired. Your account will be locked if you fail to follow these guidelines. #START_HELP_DESC#Details#END_HELP_DESC#";
$MESS["IMCONNECTOR_COMPONENT_FACEBOOK_TO_CONNECT_HUMAN_AGENT_OFF"] = "Messaging window was not extended from 24 hours to 7 days";
$MESS["IMCONNECTOR_COMPONENT_FACEBOOK_TO_CONNECT_HUMAN_AGENT_ON"] = "Messaging window extended from 24 hours to 7 days";
