...
if (!empty($arResult['NEED_META_RESTRICTION_NOTE']) && !$arResult['ACTIVE_STATUS'])
{
	...
	<div class="imconnector-restriction-note">
		<?= Loc::getMessage('IMCONNECTOR_COMPONENT_FBINSTAGRAM_RESTRICTIONS_META_RU_MSGVER_1')?>
	</div>
	<?php
	$this->EndViewTarget();
}
					...
					<div class="imconnector-field-box" data-role="more-info">
						...
						<div class="imconnector-field-box-content">
							...
							<ul class="imconnector-field-box-content-text-items">
								<li class="imconnector-field-box-content-text-item"><?= Loc::getMessage('IMCONNECTOR_COMPONENT_FBINSTAGRAM_INDEX_LIST_ITEM_1') ?></li>
								<li class="imconnector-field-box-content-text-item"><?= Loc::getMessage('IMCONNECTOR_COMPONENT_FBINSTAGRAM_INDEX_LIST_ITEM_2') ?></li>
								<li class="imconnector-field-box-content-text-item"><?= Loc::getMessage('IMCONNECTOR_COMPONENT_FBINSTAGRAM_INDEX_LIST_ITEM_3') ?></li>
								<li class="imconnector-field-box-content-text-item"><?= Loc::getMessage('IMCONNECTOR_COMPONENT_FBINSTAGRAM_INDEX_LIST_ITEM_4') ?></li>
							</ul>
