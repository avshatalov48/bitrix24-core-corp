...
/* ORMENTITYANNOTATION:Bitrix\ImConnector\Model\BotFrameworkTable:imconnector/lib/model/botframework.php:9bfa800d09dde726f9027ab9f0907a46 */
namespace Bitrix\ImConnector\Model {
	/**
	 * EO_BotFramework
	 * @see \Bitrix\ImConnector\Model\BotFrameworkTable
	 *
	 * Custom methods:
	 * ---------------
	 *
	 * @method \int getId()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework setId(\int|\Bitrix\Main\DB\SqlExpression $id)
	 * @method bool hasId()
	 * @method bool isIdFilled()
	 * @method bool isIdChanged()
	 * @method \string getIdChat()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework setIdChat(\string|\Bitrix\Main\DB\SqlExpression $idChat)
	 * @method bool hasIdChat()
	 * @method bool isIdChatFilled()
	 * @method bool isIdChatChanged()
	 * @method \string remindActualIdChat()
	 * @method \string requireIdChat()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework resetIdChat()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework unsetIdChat()
	 * @method \string fillIdChat()
	 * @method \string getIdMessage()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework setIdMessage(\string|\Bitrix\Main\DB\SqlExpression $idMessage)
	 * @method bool hasIdMessage()
	 * @method bool isIdMessageFilled()
	 * @method bool isIdMessageChanged()
	 * @method \string remindActualIdMessage()
	 * @method \string requireIdMessage()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework resetIdMessage()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework unsetIdMessage()
	 * @method \string fillIdMessage()
	 * @method \string getVirtualConnector()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework setVirtualConnector(\string|\Bitrix\Main\DB\SqlExpression $virtualConnector)
	 * @method bool hasVirtualConnector()
	 * @method bool isVirtualConnectorFilled()
	 * @method bool isVirtualConnectorChanged()
	 * @method \string remindActualVirtualConnector()
	 * @method \string requireVirtualConnector()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework resetVirtualConnector()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework unsetVirtualConnector()
	 * @method \string fillVirtualConnector()
	 * @method \string getData()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework setData(\string|\Bitrix\Main\DB\SqlExpression $data)
	 * @method bool hasData()
	 * @method bool isDataFilled()
	 * @method bool isDataChanged()
	 * @method \string remindActualData()
	 * @method \string requireData()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework resetData()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework unsetData()
	 ...
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework set($fieldName, $value)
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework reset($fieldName)
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework unset($fieldName)
	 ...
	 * @method static \Bitrix\ImConnector\Model\EO_BotFramework wakeUp($data)
	 */
	class EO_BotFramework {
		/* @var \Bitrix\ImConnector\Model\BotFrameworkTable */
		static public $dataClass = '\Bitrix\ImConnector\Model\BotFrameworkTable';
		/**
...
namespace Bitrix\ImConnector\Model {
	/**
	 * EO_BotFramework_Collection
	 *
	 * Custom methods:
	 * ---------------
	 *
	 * @method \int[] getIdList()
	 * @method \string[] getIdChatList()
	 * @method \string[] fillIdChat()
	 * @method \string[] getIdMessageList()
	 * @method \string[] fillIdMessage()
	 * @method \string[] getVirtualConnectorList()
	 * @method \string[] fillVirtualConnector()
	 ...
	 *
	 * @property-read \Bitrix\Main\ORM\Entity $entity
	 * @method void add(\Bitrix\ImConnector\Model\EO_BotFramework $object)
	 * @method bool has(\Bitrix\ImConnector\Model\EO_BotFramework $object)
	 * @method bool hasByPrimary($primary)
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework getByPrimary($primary)
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework[] getAll()
	 * @method bool remove(\Bitrix\ImConnector\Model\EO_BotFramework $object)
	 * @method void removeByPrimary($primary)
	 * @method void fill($fields = \Bitrix\Main\ORM\Fields\FieldTypeMask::ALL) flag or array of field names
	 * @method static \Bitrix\ImConnector\Model\EO_BotFramework_Collection wakeUp($data)
	 ...
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework current() Iterator
	 * @method mixed key() Iterator
	 * @method void next() Iterator
	 * @method bool valid() Iterator
	 * @method int count() Countable
	 */
	class EO_BotFramework_Collection implements \ArrayAccess, \Iterator, \Countable {
		/* @var \Bitrix\ImConnector\Model\BotFrameworkTable */
		static public $dataClass = '\Bitrix\ImConnector\Model\BotFrameworkTable';
	}
}
namespace Bitrix\ImConnector\Model {
	 ...
	 * ---------------
	 *
	 * @method EO_BotFramework_Result exec()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework fetchObject()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework_Collection fetchCollection()
	 *
	 * Custom methods:
	 * ---------------
	 *
	 */
	class EO_BotFramework_Query extends \Bitrix\Main\ORM\Query\Query {}
	/**
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework fetchObject()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework_Collection fetchCollection()
	 */
	class EO_BotFramework_Result extends \Bitrix\Main\ORM\Query\Result {}
	/**
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework createObject($setDefaultValues = true)
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework_Collection createCollection()
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework wakeUpObject($row)
	 * @method \Bitrix\ImConnector\Model\EO_BotFramework_Collection wakeUpCollection($rows)
	 */
	class EO_BotFramework_Entity extends \Bitrix\Main\ORM\Entity {}
}
